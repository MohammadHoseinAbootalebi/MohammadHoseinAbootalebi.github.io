...
Cree e implemente aplicaciones web sofisticadas con Django. Aprenda los conceptos básicos para crear un sitio web completo con Django
...
Esta especialización introduce a los programadores de Python a la creación de sitios web utilizando la biblioteca Django. En los cuatro cursos, aprenderá HTML, CSS, SQL, Django, JavaScript, jQuery y servicios web JSON. Durante el curso, creará sitios web en línea utilizando Django y los sitios web que funcionen se calificarán a lo largo del curso. Esta serie es una excelente preparación para aprender otras formas de crear aplicaciones web utilizando tecnologías como PHP (Web Applications for Everybody), Flask o Ruby on Rails. Este es un excelente primer curso en cualquier plan de estudios de desarrollo web.

Se recomienda a los estudiantes que realicen la especialización Python for Everybody o equivalente antes de comenzar esta especialización. A algunos les puede resultar útil realizar la especialización Web Design for Everybody antes o después de esta serie.

Proyecto de aprendizaje aplicado

En esta especialización, los estudiantes aprenderán a crear aplicaciones Django y, al final del curso, habrán creado un sitio web simple para almacenar y ver anuncios clasificados con funciones como fotos, búsqueda y favoritos. Este sitio web estará en producción y podría agregarse al portafolio de un estudiante.

[🔗 Enlace del curso 🔗](https://www.coursera.org/specializations/django)
