...
Créez et déployez des applications Web riches à l'aide de Django. Découvrez les principes fondamentaux de la création d'un site Web complet à l'aide de Django
...
Cette spécialisation permet aux programmeurs Python de créer des sites Web à l'aide de la bibliothèque Django. Au cours des quatre cours, vous apprendrez les services Web HTML, CSS, SQL, Django, JavaScript, jQuery et JSON. Au cours du cours, vous créerez des sites Web en ligne à l'aide de Django et les sites Web fonctionnels sont notés tout au long du cours. Cette série est une excellente préparation pour apprendre d'autres façons de créer des applications Web à l'aide de technologies telles que PHP (Web Applications for Everybody), Flask ou Ruby on Rails. Il s'agit d'un excellent premier cours dans tout programme de développement Web.

Les apprenants sont encouragés à suivre la spécialisation Python for Everybody ou un équivalent avant de commencer cette spécialisation. Certains peuvent trouver utile de suivre la spécialisation Web Design for Everybody avant ou après cette série.

Projet d'apprentissage appliqué

Dans cette spécialisation, les étudiants apprendront à créer des applications Django et à la fin du cours, ils auront créé un site Web simple pour stocker et afficher des petites annonces avec des fonctionnalités telles que des photos, une recherche et des favoris. Ce site Web sera en production et pourrait être ajouté au portfolio d'un étudiant.

[🔗 Lien vers le cours 🔗](https://www.coursera.org/specializations/django)
