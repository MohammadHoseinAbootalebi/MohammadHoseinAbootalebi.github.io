...
إنشاء تطبيقات ويب غنية ونشرها باستخدام Django. تعرف على أساسيات إنشاء موقع ويب كامل الميزات باستخدام Django
...
يقدم هذا التخصص لمبرمجي Python كيفية بناء مواقع الويب باستخدام مكتبة Django. ستتعلم من خلال الدورات الأربع HTML وCSS وSQL وDjango وJavaScript وjQuery وخدمات الويب JSON. أثناء الدورة، ستبني مواقع ويب عبر الإنترنت باستخدام Django وسيتم تقييم مواقع الويب العاملة طوال الدورة. تعد هذه السلسلة تحضيرًا ممتازًا لتعلم طرق أخرى لبناء تطبيقات الويب باستخدام تقنيات مثل PHP (تطبيقات الويب للجميع) أو Flask أو Ruby on Rails. إنها دورة أولى رائعة في أي منهج لتطوير الويب.

يتم تشجيع المتعلمين على أخذ تخصص Python for Everybody أو ما يعادله قبل بدء هذا التخصص. قد يجد البعض أنه من المفيد أخذ تخصص تصميم الويب للجميع قبل أو بعد هذه السلسلة.

مشروع التعلم التطبيقي

في هذا التخصص، سيتعلم الطلاب كيفية بناء تطبيقات Django وبحلول نهاية الدورة، سيكونون قد بنوا موقع ويب بسيط لتخزين وعرض الإعلانات المبوبة مع ميزات مثل الصور والبحث والمفضلة. سيكون هذا الموقع قيد الإنتاج ويمكن إضافته إلى محفظة الطالب.

[🔗 رابط الدورة 🔗](https://www.coursera.org/specializations/django)
