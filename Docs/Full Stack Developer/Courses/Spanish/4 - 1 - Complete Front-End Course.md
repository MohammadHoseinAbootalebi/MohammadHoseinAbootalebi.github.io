...
# El curso completo de desarrollo web front-end

¡Empiece como desarrollador web front-end utilizando HTML, CSS, JavaScript, jQuery y Bootstrap!
...
Si quieres aprender desarrollo web y conseguir un trabajo en la industria tecnológica, ¡este curso te va a ENCANTAR! ¡Aprende HTML, CSS, JavaScript, Bootstrap y más con más de 15 horas de tutoriales en video en HD! Este curso fue diseñado para ser extremadamente fácil para principiantes. Comenzaremos con los conceptos básicos de HTML y crearemos una página web simple. Al final de este curso, ¡podrás desarrollar y publicar tu propia extensión de Google Chrome! En este curso nos centraremos en ejercicios y proyectos de codificación. No perderás tiempo revisando presentaciones de PowerPoint innecesariamente largas. ¡Al completar este curso, tendrás una sólida cartera de proyectos de desarrollo para mostrarles a los empleadores potenciales!

[🔗 Enlace del curso 🔗](https://www.udemy.com/course/front-end-web-development/?srsltid=AfmBOoq45FP4R8722cuLm4u6zYjn0paY7mzyUWzJm1HSObkZfv8CIBbW&couponCode=ST3MT200225A#instructor-2)
