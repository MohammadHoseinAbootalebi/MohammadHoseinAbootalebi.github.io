    ...
    "UI & UX Designer": [
        // User Research 2nd Edition stephanie Marsh
        {
            ...
            "shortDescriptionsForPageBookReviewing": {
                ...
                // German
                "Deutsch": "Obwohl Unternehmen oft darauf ausgerichtet sind, attraktive Erfahrungen, Produkte und Dienstleistungen für Verbraucher zu schaffen, berücksichtigen viele bei ihren Planungs- und Entwicklungsprozessen den Endbenutzer nicht. Dieses Buch soll das ändern.",
                // Chinese
                "中国人": "尽管企业通常致力于为消费者创造理想的体验、产品和服务，但许多企业在规划和开发过程中却未能考虑最终用户。本书旨在改变这一现状。",
                // Russian
                "Русский": "Несмотря на то, что бизнес часто основан на создании желаемого опыта, продуктов и услуг для потребителей, многие не учитывают конечного пользователя в своих процессах планирования и разработки. Эта книга призвана изменить это.",
                // French
                "Français": "Bien que les entreprises s’appuient souvent sur la création d’expériences, de produits et de services désirables pour les consommateurs, nombre d’entre elles ne prennent pas en compte l’utilisateur final dans leurs processus de planification et de développement. Ce livre est là pour changer cela.",
                // Japanese
                "日本語": "ビジネスは多くの場合、消費者にとって望ましい体験、製品、サービスを生み出すことに基づいていますが、計画や開発のプロセスでエンドユーザーを考慮していない企業が多くあります。この本は、それを変えるためにあります。",
                // Korean
                "한국인": "기업은 종종 소비자를 위한 바람직한 경험, 제품 및 서비스를 창출하는 데 기반을 두고 있음에도 불구하고 많은 기업이 계획 및 개발 프로세스에서 최종 사용자를 고려하지 않습니다. 이 책은 그것을 바꾸기 위해 나왔습니다.",
                // Spanish
                "Español": "A pesar de que las empresas a menudo se basan en la creación de experiencias, productos y servicios deseables para los consumidores, muchas no consideran al usuario final en sus procesos de planificación y desarrollo. Este libro está aquí para cambiar eso.",
                // Hindi
                "हिंदी": "हालाँकि व्यवसाय अक्सर उपभोक्ताओं के लिए वांछनीय अनुभव, उत्पाद और सेवाएँ बनाने पर आधारित होते हैं, फिर भी कई व्यवसाय अपनी योजना और विकास प्रक्रियाओं में अंतिम उपयोगकर्ता पर विचार करने में विफल रहते हैं। यह पुस्तक इसे बदलने के लिए है।",
                // Portuguese
                "Português": "Apesar de as empresas muitas vezes se basearem na criação de experiências, produtos e serviços desejáveis ​​para os consumidores, muitas não consideram o utilizador final nos seus processos de planeamento e desenvolvimento. Este livro está aqui para mudar isso.",
                // Bengali
                "বাংলা": "ব্যবসাগুলি প্রায়ই গ্রাহকদের জন্য পছন্দসই অভিজ্ঞতা, পণ্য এবং পরিষেবা তৈরির উপর ভিত্তি করে থাকা সত্ত্বেও, অনেকেই তাদের পরিকল্পনা এবং বিকাশের প্রক্রিয়াগুলিতে শেষ ব্যবহারকারীকে বিবেচনা করতে ব্যর্থ হয়। এই বই এখানে যে পরিবর্তন.",
                // Arabic
                "عَرَبِيّ": "على الرغم من أن الشركات غالبًا ما تعتمد على خلق تجارب ومنتجات وخدمات مرغوبة للمستهلكين، إلا أن الكثير منها يفشل في أخذ المستخدم النهائي بعين الاعتبار في عمليات التخطيط والتطوير. هذا الكتاب هنا لتغيير ذلك.",
                // Persian
        ...
        // Don't make me think Steve Krug
        {
            ...
            "shortDescriptionsForPageBookReviewing": {
                ...
                // German
                "Deutsch": "Seit der Erstveröffentlichung von „Don’t Make Me Think“ im Jahr 2000 haben sich über 400.000 Webdesigner und -entwickler auf Steve Krugs Handbuch verlassen, um die Prinzipien der intuitiven Navigation und des Informationsdesigns zu verstehen.",
                // Chinese
                "中国人": "自 2000 年《别让我思考》首次出版以来，已有超过 400,000 名网页设计师和开发人员依靠史蒂夫·克鲁格 (Steve Krug) 的指南来帮助他们理解直观导航和信息设计的原则。",
                // Russian
                "Русский": "С тех пор, как книга «Не заставляйте меня думать» была впервые опубликована в 2000 году, более 400 000 веб-дизайнеров и разработчиков воспользовались руководством Стива Круга, которое помогло им понять принципы интуитивной навигации и информационного дизайна.",
                // French
                "Français": "Depuis la première publication de Don't Make Me Think en 2000, plus de 400 000 concepteurs et développeurs Web se sont appuyés sur le guide de Steve Krug pour les aider à comprendre les principes de la navigation intuitive et de la conception de l'information.",
                // Japanese
                "日本語": "『Don’t Make Me Think』が 2000 年に初めて出版されて以来、40 万人を超える Web デザイナーや開発者が、直感的なナビゲーションと情報デザインの原則を理解するために Steve Krug のガイドを活用してきました。",
                // Korean
                "한국인": "Don't Make Me Think가 2000년에 처음 출판된 이후로 400,000명이 넘는 웹 디자이너와 개발자가 Steve Krug의 가이드를 활용하여 직관적인 탐색 및 정보 디자인의 원리를 이해하는 데 도움을 주었습니다.",
                // Spanish
                "Español": "Desde que Don't Make Me Think se publicó por primera vez en 2000, más de 400.000 diseñadores y desarrolladores web han confiado en la guía de Steve Krug para ayudarles a comprender los principios de la navegación intuitiva y el diseño de la información.",
                // Hindi
                "हिंदी": "वर्ष 2000 में डोंट मेक मी थिंक के पहली बार प्रकाशित होने के बाद से, 400,000 से अधिक वेब डिज़ाइनरों और डेवलपर्स ने सहज ज्ञान युक्त नेविगेशन और सूचना डिज़ाइन के सिद्धांतों को समझने में मदद के लिए स्टीव क्रुग की मार्गदर्शिका पर भरोसा किया है।",
                // Portuguese
                "Português": "Desde que Don’t Make Me Think foi publicado pela primeira vez em 2000, mais de 400.000 Web designers e desenvolvedores confiaram no guia de Steve Krug para ajudá-los a compreender os princípios da navegação intuitiva e do design da informação.",
                // Bengali
                "বাংলা": "যেহেতু ডোন্ট মেক মি থিঙ্ক 2000 সালে প্রথম প্রকাশিত হয়েছিল, 400,000 এরও বেশি ওয়েব ডিজাইনার এবং বিকাশকারীরা তাদের স্বজ্ঞাত নেভিগেশন এবং তথ্য ডিজাইনের নীতিগুলি বুঝতে সাহায্য করার জন্য স্টিভ ক্রুগের গাইডের উপর নির্ভর করেছেন।",
                // Arabic
                "عَرَبِيّ": "منذ نشر كتاب 'لا تجعلني أفكر' لأول مرة في عام 2000، اعتمد أكثر من 400000 من مصممي ومطوري الويب على دليل ستيف كروغ لمساعدتهم على فهم مبادئ التنقل البديهي وتصميم المعلومات.",
                // Persian
    ...
    "Flutter Developer": [
        // Flutter complete reference book
        {
            ...
            "shortDescriptionsForPageBookReviewing": {
                ...
                // German
                "Deutsch": "Flutter ist Googles UI-Toolkit zum Erstellen ansprechender und nativer Anwendungen für Mobilgeräte, Desktops und das Web aus einer einzigen Dart-Codebasis. In diesem Buch behandeln wir ausführlich die Programmiersprache Dart und das Flutter-Framework.",
                // Chinese
                "中国人": "Flutter 是 Google 的 UI 工具包，用于通过单个 Dart 代码库为移动设备、桌面和 Web 创建美观的原生应用。本书详细介绍了 Dart 编程语言和 Flutter 框架。",
                // Russian
                "Русский": "Flutter — это набор инструментов пользовательского интерфейса Google для создания красивых и нативных приложений для мобильных устройств, настольных компьютеров и Интернета на основе единой базы кода Dart. В этой книге мы подробно рассмотрим язык программирования Dart и среду Flutter.",
                // French
                "Français": "Flutter est la boîte à outils d'interface utilisateur de Google permettant de créer de belles applications natives pour mobile, ordinateur de bureau et Web à partir d'une seule base de code Dart. Dans ce livre, nous couvrons en détail le langage de programmation Dart et le framework Flutter.",
                // Japanese
                "日本語": "Flutter は、単一の Dart コードベースからモバイル、デスクトップ、Web 向けの美しいネイティブ アプリケーションを作成するための Google の UI ツールキットです。この本では、Dart プログラミング言語と Flutter フレームワークについて詳しく説明します。",
                // Korean
                "한국인": "Flutter는 단일 Dart 코드베이스에서 모바일, 데스크톱, 웹용 아름다운 기본 애플리케이션을 만들기 위한 Google의 UI 툴킷입니다. 이 책에서는 Dart 프로그래밍 언어와 Flutter 프레임워크를 자세히 다룹니다.",
                // Spanish
                "Español": "Flutter es el conjunto de herramientas de interfaz de usuario de Google para crear aplicaciones hermosas y nativas para dispositivos móviles, de escritorio y web desde una única base de código Dart. En este libro cubrimos en detalle el lenguaje de programación Dart y el marco Flutter.",
                // Hindi
                "हिंदी": "फ़्लटर Google का UI टूलकिट है, जो एक ही डार्ट कोडबेस से मोबाइल, डेस्कटॉप और वेब के लिए सुंदर और मूल एप्लिकेशन बनाने के लिए है। इस पुस्तक में हम डार्ट प्रोग्रामिंग भाषा और फ़्लटर फ़्रेमवर्क के बारे में विस्तार से बताएंगे।",
                // Portuguese
                "Português": "Flutter é o kit de ferramentas de UI do Google para criar aplicativos bonitos e nativos para dispositivos móveis, desktop e web a partir de uma única base de código Dart. Neste livro abordamos detalhadamente a linguagem de programação Dart e o framework Flutter.",
                // Bengali
                "বাংলা": "একটি একক ডার্ট কোডবেস থেকে মোবাইল, ডেস্কটপ এবং ওয়েবের জন্য সুন্দর এবং নেটিভ অ্যাপ্লিকেশন তৈরি করার জন্য Flutter হল Google-এর UI টুলকিট। এই বইটিতে আমরা ডার্ট প্রোগ্রামিং ভাষা এবং ফ্লাটার ফ্রেমওয়ার্কের বিস্তারিত কভার করেছি।",
                // Arabic
                "عَرَبِيّ": "Flutter هي مجموعة أدوات واجهة مستخدم Google لإنشاء تطبيقات جميلة ومبتكرة للجوال وسطح المكتب والويب من قاعدة بيانات Dart واحدة. في هذا الكتاب نغطي بالتفصيل لغة البرمجة Dart وإطار عمل Flutter.",
                // Persian
        ...
        // Flutter Apprentice
        {
            ...
            "shortDescriptionsForPageBookReviewing": {
                ...
                // German
                "Deutsch": "Flutter ist ein spannendes Entwicklungstoolkit, mit dem Sie Apps für iOS, Android und sogar Web und Desktop erstellen können – alles aus einer einzigen Codebasis. Es verwendet einen deklarativen Ansatz für die UI-Entwicklung. Sie können Code während der Entwicklung „hot reloaden“ und Apps werden dank der benutzerdefinierten Rendering-Engine mit nativer Geschwindigkeit ausgeführt. Mit Flutter und Flutter Apprentice können Sie Ihren Traum verwirklichen, schnelle Anwendungen schneller zu erstellen.",
                // Chinese
                "中国人": "Flutter 是一款令人兴奋的开发工具包，可让您从单个代码库构建适用于 iOS、Android 甚至 Web 和桌面的应用程序。它使用声明式方法进行 UI 开发。您可以在开发过程中“热重载”代码，并且由于其自定义渲染引擎，应用程序将以本机速度运行。借助 Flutter 和 Flutter Apprentice，您可以更快地实现构建快速应用程序的梦想。",
                // Russian
                "Русский": "Flutter — это потрясающий набор инструментов для разработки, который позволяет создавать приложения для iOS, Android и даже для Интернета и настольных компьютеров, используя единую базу кода. Он использует декларативный подход к разработке пользовательского интерфейса. Вы можете выполнить «горячую перезагрузку» кода во время разработки, и приложения будут работать с исходной скоростью благодаря специальному механизму рендеринга. С помощью Flutter и Flutter Apprentice вы сможете быстрее осуществить мечту о создании быстрых приложений.",
                // French
                "Français": "Flutter est une boîte à outils de développement passionnante qui vous permet de créer des applications pour iOS, Android et même pour le Web et le bureau, le tout à partir d'une seule base de code. Il utilise une approche déclarative du développement de l'interface utilisateur. Vous pouvez « recharger à chaud » le code pendant le développement, et les applications fonctionneront à une vitesse native grâce à son moteur de rendu personnalisé. Avec Flutter et Flutter Apprentice, vous pouvez réaliser le rêve de créer des applications rapides, plus rapidement.",
                // Japanese
                "日本語": "Flutter は、iOS、Android、さらには Web やデスクトップ向けのアプリをすべて単一のコードベースから構築できる、魅力的な開発ツールキットです。UI 開発には宣言型のアプローチを採用しています。開発中にコードを「ホット リロード」することができ、カスタム レンダリング エンジンによりアプリはネイティブ スピードで動作します。Flutter と Flutter Apprentice を使用すると、高速なアプリケーションをより速く構築するという夢を実現できます。",
                // Korean
                "한국인": "Flutter는 단일 코드베이스에서 iOS, Android는 물론 웹과 데스크톱용 앱을 모두 빌드할 수 있는 흥미로운 개발 도구 키트입니다. UI 개발에 선언적 접근 방식을 사용합니다. 개발 중에 코드를 '핫 리로드'할 수 있으며 앱은 맞춤 렌더링 엔진 덕분에 기본 속도로 작동합니다. Flutter 및 Flutter Apprentice를 사용하면 빠른 애플리케이션을 더 빠르게 구축하려는 꿈을 이룰 수 있습니다.",
                // Spanish
                "Español": "Flutter es un interesante conjunto de herramientas de desarrollo que te permite crear aplicaciones para iOS, Android e incluso web y escritorio, todo desde una única base de código. Utiliza un enfoque declarativo para el desarrollo de la interfaz de usuario. Puede 'recargar en caliente' el código mientras desarrolla y las aplicaciones funcionarán a la velocidad nativa gracias a su motor de renderizado personalizado. Con Flutter y Flutter Apprentice, puedes lograr el sueño de crear aplicaciones rápidas, más rápido.",
                // Hindi
                "हिंदी": "फ़्लटर एक रोमांचक डेवलपमेंट टूलकिट है जो आपको iOS, Android और यहां तक ​​कि वेब और डेस्कटॉप के लिए भी एक ही कोडबेस से ऐप बनाने की सुविधा देता है। यह UI डेवलपमेंट के लिए एक घोषणात्मक दृष्टिकोण का उपयोग करता है। आप विकास करते समय कोड को 'हॉट रीलोड' कर सकते हैं, और इसके कस्टम रेंडरिंग इंजन की बदौलत ऐप मूल गति से प्रदर्शन करेंगे। फ़्लटर और फ़्लटर अप्रेंटिस के साथ, आप तेज़ एप्लिकेशन बनाने का सपना तेज़ी से पूरा कर सकते हैं।",
                // Portuguese
                "Português": "Flutter é um kit de ferramentas de desenvolvimento interessante que permite criar aplicativos para iOS, Android e até mesmo para web e desktop, tudo a partir de uma única base de código. Ele usa uma abordagem declarativa para o desenvolvimento de UI. Você pode 'recarregar a quente' o código durante o desenvolvimento, e os aplicativos funcionarão em velocidade nativa graças ao seu mecanismo de renderização personalizado. Com Flutter e Flutter Apprentice, você pode realizar o sonho de construir aplicativos rápidos e rápidos.",
                // Bengali
                "বাংলা": "Flutter হল একটি উত্তেজনাপূর্ণ ডেভেলপমেন্ট টুলকিট যা আপনাকে iOS, Android এবং এমনকি ওয়েব এবং ডেস্কটপের জন্য অ্যাপ তৈরি করতে দেয়, সবই একটি একক কোডবেস থেকে। এটি UI বিকাশের জন্য একটি ঘোষণামূলক পদ্ধতি ব্যবহার করে। আপনি বিকাশ করার সময় 'হট রিলোড' কোড করতে পারেন এবং অ্যাপগুলি তার কাস্টম রেন্ডারিং ইঞ্জিনের জন্য নেটিভ গতিতে পারফর্ম করবে। ফ্লটার এবং ফ্লটার অ্যাপ্রেন্টিসের মাধ্যমে, আপনি দ্রুত অ্যাপ্লিকেশন তৈরির স্বপ্ন, দ্রুত অর্জন করতে পারেন।",
                // Arabic
                "عَرَبِيّ": "Flutter عبارة عن مجموعة أدوات تطوير مثيرة تتيح لك إنشاء تطبيقات لنظام التشغيل iOS وAndroid وحتى الويب وسطح المكتب، كل ذلك من قاعدة تعليمات برمجية واحدة. ويستخدم نهجا تعريفيا لتطوير واجهة المستخدم. يمكنك 'إعادة التحميل السريع' للتعليمات البرمجية أثناء التطوير، وستعمل التطبيقات بالسرعة الأصلية بفضل محرك العرض المخصص الخاص بها. مع Flutter وFlutter Apprentice، يمكنك تحقيق حلم إنشاء تطبيقات سريعة، بشكل أسرع.",
                // Persian
    ...
    "AI Engineer": [
        // Deep Learning from Scratch
        {
            ...
            "shortDescriptionsForPageBookReviewing": {
                ...
                // German
                "Deutsch": "Mit dem Wiederaufleben neuronaler Netzwerke in den 2010er Jahren ist Deep Learning für Praktiker des maschinellen Lernens und sogar für viele Softwareentwickler unverzichtbar geworden. Dieses Buch bietet eine umfassende Einführung für Datenwissenschaftler und Softwareentwickler mit Erfahrung im maschinellen Lernen. Sie beginnen mit den Grundlagen des Deep Learning und gehen schnell zu den Details wichtiger fortgeschrittener Architekturen über, wobei Sie dabei alles von Grund auf neu implementieren. Autor Seth Weidman zeigt Ihnen, wie neuronale Netzwerke mithilfe eines First-Principles-Ansatzes funktionieren. Sie lernen, wie Sie mehrschichtige neuronale Netzwerke, Convolutional Neural Networks und Recurrent Neural Networks von Grund auf anwenden. Mit einem gründlichen Verständnis der mathematischen, rechnerischen und konzeptionellen Funktionsweise neuronaler Netzwerke sind Sie für den Erfolg aller zukünftigen Deep-Learning-Projekte gerüstet.",
                // Chinese
                "中国人": "随着 2010 年代神经网络的复兴，深度学习已成为机器学习从业者乃至许多软件工程师的必备技能。本书为具有机器学习经验的数据科学家和软件工程师提供了全面的介绍。您将从深度学习基础知识开始，快速了解重要高级架构的细节，并在此过程中从头开始实现所有内容。作者 Seth Weidman 使用第一原理方法向您展示了神经网络的工作原理。您将学习如何从头开始应用多层神经网络、卷积神经网络和循环神经网络。通过彻底了解神经网络在数学、计算和概念上的工作原理，您将为所有未来的深度学习项目取得成功做好准备。",
                // Russian
                "Русский": "С возрождением нейронных сетей в 2010-х годах глубокое обучение стало важным для специалистов по машинному обучению и даже для многих инженеров-программистов. Эта книга представляет собой всеобъемлющее введение для специалистов по данным и инженеров-программистов, имеющих опыт машинного обучения. Вы начнете с основ глубокого изучения и быстро перейдете к деталям важных продвинутых архитектур, реализуя все с нуля. Автор Сет Вайдман показывает, как работают нейронные сети, используя подход из первых принципов. Вы узнаете, как применять многослойные нейронные сети, сверточные нейронные сети и рекуррентные нейронные сети с нуля. Имея глубокое понимание того, как нейронные сети работают математически, вычислительно и концептуально, вы будете готовы к успеху во всех будущих проектах глубокого обучения.",
                // French
                "Français": "Avec la résurgence des réseaux de neurones dans les années 2010, le deep learning est devenu essentiel pour les praticiens du machine learning et même pour de nombreux ingénieurs logiciels. Ce livre fournit une introduction complète aux scientifiques des données et aux ingénieurs logiciels ayant une expérience en apprentissage automatique. Vous commencerez par les bases du deep learning et passerez rapidement aux détails des architectures avancées importantes, en mettant en œuvre tout à partir de zéro en cours de route. L'auteur Seth Weidman vous montre comment fonctionnent les réseaux de neurones en utilisant une approche fondée sur les premiers principes. Vous apprendrez à appliquer des réseaux de neurones multicouches, des réseaux de neurones convolutifs et des réseaux de neurones récurrents à partir de zéro. Avec une compréhension approfondie du fonctionnement mathématique, informatique et conceptuel des réseaux de neurones, vous serez prêt à réussir dans tous les futurs projets d'apprentissage en profondeur.",
                // Japanese
                "日本語": "2010 年代にニューラル ネットワークが復活したことで、ディープラーニングは機械学習の実践者、さらには多くのソフトウェア エンジニアにとって不可欠なものとなりました。本書は、機械学習の経験を持つデータ サイエンティストやソフトウェア エンジニア向けに包括的な入門書です。ディープラーニングの基礎から始めて、重要な高度なアーキテクチャの詳細にすばやく進み、その過程ですべてをゼロから実装します。著者の Seth Weidman は、第一原理アプローチを使用してニューラル ネットワークの仕組みを説明します。多層ニューラル ネットワーク、畳み込みニューラル ネットワーク、および再帰型ニューラル ネットワークを基礎から適用する方法を学びます。ニューラル ネットワークが数学的、計算的、および概念的にどのように機能するかを完全に理解することで、将来のすべてのディープラーニング プロジェクトで成功するための準備が整います。",
                // Korean
                "한국인": "2010년대 신경망이 부활하면서 딥러닝은 머신러닝 실무자와 많은 소프트웨어 엔지니어에게 필수적인 요소가 되었습니다. 이 책은 머신러닝 경험이 있는 데이터 과학자와 소프트웨어 엔지니어를 위한 포괄적인 소개를 제공합니다. 딥 러닝 기본 사항부터 시작하여 중요한 고급 아키텍처의 세부 사항으로 빠르게 이동하여 처음부터 모든 것을 구현하게 됩니다. 저자 Seth Weidman은 첫 번째 원칙 접근 방식을 사용하여 신경망이 어떻게 작동하는지 보여줍니다. 다층 신경망, 컨벌루션 신경망, 순환 신경망을 처음부터 적용하는 방법을 배우게 됩니다. 신경망이 수학적으로, 계산적으로, 개념적으로 작동하는 방식을 철저히 이해하면 향후 모든 딥 러닝 프로젝트에서 성공할 수 있는 준비를 갖추게 됩니다.",
                // Spanish
                "Español": "Con el resurgimiento de las redes neuronales en la década de 2010, el aprendizaje profundo se ha vuelto esencial para los profesionales del aprendizaje automático e incluso para muchos ingenieros de software. Este libro proporciona una introducción completa para científicos de datos e ingenieros de software con experiencia en aprendizaje automático. Comenzará con los conceptos básicos del aprendizaje profundo y avanzará rápidamente a los detalles de arquitecturas avanzadas importantes, implementando todo desde cero a lo largo del camino. El autor Seth Weidman le muestra cómo funcionan las redes neuronales utilizando un enfoque de primeros principios. Aprenderá cómo aplicar redes neuronales multicapa, redes neuronales convolucionales y redes neuronales recurrentes desde cero. Con un conocimiento profundo de cómo funcionan las redes neuronales matemática, computacional y conceptualmente, estará preparado para el éxito en todos los proyectos futuros de aprendizaje profundo.",
                // Hindi
                "हिंदी": "2010 के दशक में न्यूरल नेटवर्क के पुनरुत्थान के साथ, मशीन लर्निंग प्रैक्टिशनर्स और यहां तक ​​कि कई सॉफ्टवेयर इंजीनियरों के लिए डीप लर्निंग आवश्यक हो गई है। यह पुस्तक मशीन लर्निंग अनुभव वाले डेटा वैज्ञानिकों और सॉफ्टवेयर इंजीनियरों के लिए एक व्यापक परिचय प्रदान करती है। आप डीप लर्निंग की मूल बातों से शुरू करेंगे और महत्वपूर्ण उन्नत आर्किटेक्चर के विवरण पर जल्दी से आगे बढ़ेंगे, रास्ते में सब कुछ खरोंच से लागू करेंगे। लेखक सेठ वीडमैन आपको दिखाते हैं कि पहले सिद्धांतों के दृष्टिकोण का उपयोग करके न्यूरल नेटवर्क कैसे काम करते हैं। आप सीखेंगे कि मल्टीलेयर न्यूरल नेटवर्क, कन्वोल्यूशनल न्यूरल नेटवर्क और रीकरंट न्यूरल नेटवर्क को कैसे शुरू से लागू किया जाए। न्यूरल नेटवर्क गणितीय, कम्प्यूटेशनल और वैचारिक रूप से कैसे काम करते हैं, इसकी पूरी समझ के साथ, आप भविष्य की सभी डीप लर्निंग परियोजनाओं में सफलता के लिए तैयार होंगे।",
                // Portuguese
                "Português": "Com o ressurgimento das redes neurais na década de 2010, o aprendizado profundo tornou-se essencial para profissionais de aprendizado de máquina e até mesmo para muitos engenheiros de software. Este livro fornece uma introdução abrangente para cientistas de dados e engenheiros de software com experiência em aprendizado de máquina. Você começará com o básico do aprendizado profundo e avançará rapidamente para os detalhes de importantes arquiteturas avançadas, implementando tudo do zero ao longo do caminho. O autor Seth Weidman mostra como as redes neurais funcionam usando uma abordagem de primeiros princípios. Você aprenderá como aplicar redes neurais multicamadas, redes neurais convolucionais e redes neurais recorrentes desde o início. Com uma compreensão completa de como as redes neurais funcionam matematicamente, computacionalmente e conceitualmente, você estará preparado para o sucesso em todos os futuros projetos de aprendizagem profunda.",
                // Bengali
                "বাংলা": "2010 এর দশকে নিউরাল নেটওয়ার্কের পুনরুত্থানের সাথে, মেশিন লার্নিং অনুশীলনকারীদের এমনকি অনেক সফ্টওয়্যার ইঞ্জিনিয়ারদের জন্য গভীর শিক্ষা অপরিহার্য হয়ে উঠেছে। এই বইটি মেশিন লার্নিং অভিজ্ঞতা সহ ডেটা বিজ্ঞানী এবং সফ্টওয়্যার ইঞ্জিনিয়ারদের জন্য একটি ব্যাপক ভূমিকা প্রদান করে৷ আপনি গভীর শিক্ষার মূল বিষয়গুলি দিয়ে শুরু করবেন এবং গুরুত্বপূর্ণ উন্নত আর্কিটেকচারের বিশদ বিবরণে দ্রুত চলে যাবেন, পথের ধারে শুরু থেকে সবকিছু বাস্তবায়ন করবেন। লেখক সেথ ওয়েডম্যান আপনাকে দেখায় কিভাবে নিউরাল নেটওয়ার্ক প্রথম নীতির পদ্ধতি ব্যবহার করে কাজ করে। আপনি শিখবেন কিভাবে মাল্টিলেয়ার নিউরাল নেটওয়ার্ক, কনভোল্যুশনাল নিউরাল নেটওয়ার্ক এবং রিকারেন্ট নিউরাল নেটওয়ার্ক প্রয়োগ করতে হয়। নিউরাল নেটওয়ার্কগুলি কীভাবে গাণিতিক, গণনাগতভাবে এবং ধারণাগতভাবে কাজ করে তার পুঙ্খানুপুঙ্খ বোঝার সাথে, আপনি ভবিষ্যতের সমস্ত গভীর শিক্ষার প্রকল্পে সাফল্যের জন্য সেট আপ হবেন।",
                // Arabic
                "عَرَبِيّ": "مع عودة ظهور الشبكات العصبية في عام 2010، أصبح التعلم العميق ضروريًا لممارسي التعلم الآلي وحتى العديد من مهندسي البرمجيات. يقدم هذا الكتاب مقدمة شاملة لعلماء البيانات ومهندسي البرمجيات ذوي الخبرة في التعلم الآلي. ستبدأ بأساسيات التعلم العميق وستنتقل سريعًا إلى تفاصيل البنى المتقدمة المهمة، وستنفذ كل شيء من الصفر على طول الطريق. يوضح لك المؤلف سيث ويدمان كيفية عمل الشبكات العصبية باستخدام نهج المبادئ الأولى. سوف تتعلم كيفية تطبيق الشبكات العصبية متعددة الطبقات والشبكات العصبية التلافيفية والشبكات العصبية المتكررة من الألف إلى الياء. من خلال الفهم الشامل لكيفية عمل الشبكات العصبية رياضيًا وحسابيًا ومفاهيميًا، سيتم إعدادك للنجاح في جميع مشاريع التعلم العميق المستقبلية.",
                // Persian
    ...
    "Industrial Designer": [
        // SOLIDWORKS 2020 Basic Tools - Getting Started with Parts Assemblies and Drawings
        {
            ...
            "shortDescriptionsForPageBookReviewing": {
                ...
                // German
                "Deutsch": "SOLIDWORKS 2020 Basic Tools ist das erste Buch einer dreiteiligen Reihe. Es führt neue Benutzer in die SOLIDWORKS-Benutzeroberfläche, SOLIDWORKS-Tools und grundlegende Modellierungstechniken ein. Es vermittelt Ihnen ein fundiertes Verständnis von SOLIDWORKS und behandelt die Erstellung von Teilen, Baugruppen und Zeichnungen. Jede Lektion und Übung in diesem Buch wurde auf der Grundlage realer Projekte erstellt. Jedes dieser Projekte wurde in einfache und verständliche Schritte unterteilt und entwickelt. Darüber hinaus gibt es am Ende jedes Kapitels Selbsttestfragebögen, um sicherzustellen, dass Sie aus jedem Abschnitt ausreichend Wissen gewonnen haben, bevor Sie mit fortgeschritteneren Lektionen fortfahren. Dieses Buch verfolgt den Ansatz, dass Sie, um SOLIDWORKS in- und auswendig zu verstehen, alles von Grund auf erstellen und Schritt für Schritt durchgehen sollten.",
                // Chinese
                "中国人": "SOLIDWORKS 2020 Basic Tools 是三部分系列的第一本书。它向新用户介绍了 SOLIDWORKS 界面、SOLIDWORKS 工具和基本建模技术。它为您提供了对 SOLIDWORKS 的深入了解，并涵盖了零件、装配体和工程图的创建。本书中的每个课程和练习都是基于真实项目创建的。这些项目中的每一个都被分解并发展为简单易懂的步骤。此外，在每一章的末尾都有自测问卷，以确保您在进入更高级的课程之前从每个部分获得了足够的知识。本书采用的方法是，为了彻底了解 SOLIDWORKS，您应该从头开始创建一切并逐步进行。",
                // Russian
                "Русский": "SOLIDWORKS 2020 Basic Tools — первая книга из серии, состоящей из трех частей. Он знакомит новых пользователей с интерфейсом SOLIDWORKS, инструментами SOLIDWORKS и основными методами моделирования. Он дает вам глубокое понимание SOLIDWORKS и охватывает создание деталей, сборок и чертежей. Каждый урок и упражнение в этой книге созданы на основе реальных проектов. Каждый из этих проектов был разбит на простые и понятные этапы. Кроме того, в конце каждой главы приведены анкеты для самопроверки, позволяющие убедиться, что вы получили достаточные знания по каждому разделу, прежде чем переходить к более продвинутым урокам. В этой книге используется подход, согласно которому для понимания SOLIDWORKS изнутри и снаружи необходимо создать все с самого начала и делать это шаг за шагом.",
                // French
                "Français": "SOLIDWORKS 2020 Basic Tools est le premier livre d'une série en trois parties. Il présente aux nouveaux utilisateurs l'interface SOLIDWORKS, les outils SOLIDWORKS et les techniques de modélisation de base. Il vous offre une solide compréhension de SOLIDWORKS et couvre la création de pièces, d'assemblages et de dessins. Chaque leçon et exercice de ce livre a été créé sur la base de projets du monde réel. Chacun de ces projets a été décomposé et développé en étapes simples et compréhensibles. De plus, à la fin de chaque chapitre, vous trouverez des questionnaires d'auto-test pour vous assurer que vous avez acquis suffisamment de connaissances dans chaque section avant de passer à des leçons plus avancées. Ce livre adopte l'approche selon laquelle pour comprendre SOLIDWORKS, de fond en comble, vous devez tout créer depuis le début et procéder étape par étape.",
                // Japanese
                "日本語": "SOLIDWORKS 2020 基本ツールは、3 部構成のシリーズの最初の本です。この書籍では、SOLIDWORKS インターフェース、SOLIDWORKS ツール、基本的なモデリング手法について新しいユーザーに紹介します。SOLIDWORKS をしっかりと理解できるようにし、部品、アセンブリ、図面の作成について説明します。この本のすべてのレッスンと演習は、実際のプロジェクトに基づいて作成されています。これらのプロジェクトはそれぞれ、簡単で理解しやすいステップに細分化され、開発されています。さらに、各章の最後には、より高度なレッスンに進む前に、各セクションから十分な知識を習得したことを確認するためのセルフテスト アンケートがあります。この本では、SOLIDWORKS を隅々まで理解するには、すべてを最初から作成し、ステップごとに実行する必要があるというアプローチを採用しています。",
                // Korean
                "한국인": "SOLIDWORKS 2020 기본 도구는 3부 시리즈 중 첫 번째 책입니다. 새로운 사용자에게 SOLIDWORKS 인터페이스, SOLIDWORKS 도구 및 기본 모델링 기술을 소개합니다. SOLIDWORKS에 대한 깊은 이해를 제공하고 파트, 어셈블리 및 도면 작성을 다룹니다. 이 책의 모든 강의와 연습은 실제 프로젝트를 기반으로 만들어졌습니다. 이러한 각 프로젝트는 쉽고 이해하기 쉬운 단계로 세분화되어 개발되었습니다. 또한, 모든 장의 마지막에는 더 고급 수업으로 넘어가기 전에 각 섹션에서 충분한 지식을 얻었는지 확인하기 위한 자가 테스트 설문지가 있습니다. 이 책은 SOLIDWORKS를 안팎으로 이해하려면 처음부터 모든 것을 만들고 단계별로 진행해야 한다는 접근 방식을 취합니다.",
                // Spanish
                "Español": "SOLIDWORKS 2020 Basic Tools es el primer libro de una serie de tres partes. Presenta a los nuevos usuarios la interfaz de SOLIDWORKS, las herramientas de SOLIDWORKS y las técnicas básicas de modelado. Le proporciona una sólida comprensión de SOLIDWORKS y cubre la creación de piezas, ensamblajes y dibujos. Cada lección y ejercicio de este libro se creó en base a proyectos del mundo real. Cada uno de estos proyectos se ha desglosado y desarrollado en pasos sencillos y comprensibles. Además, al final de cada capítulo hay cuestionarios de autoevaluación para garantizar que haya adquirido conocimientos suficientes de cada sección antes de pasar a lecciones más avanzadas. Este libro adopta el enfoque de que, para comprender SOLIDWORKS, por dentro y por fuera, debes crear todo desde el principio y hacerlo paso a paso.",
                // Hindi
                "हिंदी": "SOLIDWORKS 2020 बेसिक टूल्स तीन भाग वाली श्रृंखला की पहली पुस्तक है। यह नए उपयोगकर्ताओं को SOLIDWORKS इंटरफ़ेस, SOLIDWORKS टूल और बुनियादी मॉडलिंग तकनीकों से परिचित कराता है। यह आपको SOLIDWORKS की एक मजबूत समझ प्रदान करता है और भागों, संयोजनों और रेखाचित्रों के निर्माण को कवर करता है। इस पुस्तक का प्रत्येक पाठ और अभ्यास वास्तविक दुनिया की परियोजनाओं के आधार पर बनाया गया था। इनमें से प्रत्येक परियोजना को तोड़कर आसान और समझने योग्य चरणों में विकसित किया गया है। इसके अलावा, प्रत्येक अध्याय के अंत में स्व-परीक्षण प्रश्नावली हैं ताकि यह सुनिश्चित किया जा सके कि आपने अधिक उन्नत पाठों पर जाने से पहले प्रत्येक अनुभाग से पर्याप्त ज्ञान प्राप्त कर लिया है। यह पुस्तक इस दृष्टिकोण को अपनाती है कि SOLIDWORKS को अंदर और बाहर से समझने के लिए, आपको शुरुआत से ही सब कुछ बनाना चाहिए और इसे चरण दर चरण पूरा करना चाहिए।",
                // Portuguese
                "Português": "SOLIDWORKS 2020 Basic Tools é o primeiro livro de uma série de três partes. Ele apresenta aos novos usuários a interface do SOLIDWORKS, as ferramentas do SOLIDWORKS e as técnicas básicas de modelagem. Ele fornece um forte conhecimento do SOLIDWORKS e abrange a criação de peças, montagens e desenhos. Cada lição e exercício deste livro foram criados com base em projetos do mundo real. Cada um desses projetos foi dividido e desenvolvido em etapas fáceis e compreensíveis. Além disso, no final de cada capítulo há questionários de autoteste para garantir que você tenha adquirido conhecimento suficiente em cada seção antes de passar para lições mais avançadas. Este livro adota a abordagem de que, para entender o SOLIDWORKS, por dentro e por fora, você deve criar tudo desde o início e seguir passo a passo.",
                // Bengali
                "বাংলা": "সলিডওয়ার্কস 2020 বেসিক টুলস তিনটি অংশের সিরিজের প্রথম বই। এটি নতুন ব্যবহারকারীদের সলিডওয়ার্কস ইন্টারফেস, সলিডওয়ার্কস টুলস এবং মৌলিক মডেলিং কৌশলগুলির সাথে পরিচয় করিয়ে দেয়। এটি আপনাকে সলিডওয়ার্কস সম্পর্কে একটি দৃঢ় উপলব্ধি প্রদান করে এবং অংশ, সমাবেশ এবং অঙ্কন তৈরি করে। এই বইয়ের প্রতিটি পাঠ এবং অনুশীলন বাস্তব বিশ্বের প্রকল্পগুলির উপর ভিত্তি করে তৈরি করা হয়েছিল। এই প্রকল্পগুলির প্রত্যেকটি ভেঙে ফেলা হয়েছে এবং সহজ এবং বোধগম্য ধাপে তৈরি করা হয়েছে। অধিকন্তু, প্রতিটি অধ্যায়ের শেষে আরও উন্নত পাঠে যাওয়ার আগে আপনি প্রতিটি বিভাগ থেকে পর্যাপ্ত জ্ঞান অর্জন করেছেন তা নিশ্চিত করার জন্য স্ব-পরীক্ষার প্রশ্নাবলী রয়েছে। এই বইটি এই পদ্ধতিটি গ্রহণ করে যে সলিডওয়ার্কগুলিকে বোঝার জন্য, ভিতরে এবং বাইরে, আপনাকে শুরু থেকে সবকিছু তৈরি করতে হবে এবং ধাপে ধাপে এটি করতে হবে।",
                // Arabic
                "عَرَبِيّ": "SOLIDWORKS 2020 Basic Tools هو الكتاب الأول في سلسلة مكونة من ثلاثة أجزاء. يقدم للمستخدمين الجدد واجهة SOLIDWORKS وأدوات SOLIDWORKS وتقنيات النمذجة الأساسية. فهو يوفر لك فهمًا قويًا لـ SOLIDWORKS ويغطي إنشاء الأجزاء والتجميعات والرسومات. تم إنشاء كل درس وتمرين في هذا الكتاب بناءً على مشاريع واقعية. وقد تم تقسيم كل من هذه المشاريع وتطويرها إلى خطوات سهلة ومفهومة. علاوة على ذلك، توجد في نهاية كل فصل استبيانات اختبار ذاتي للتأكد من أنك اكتسبت المعرفة الكافية من كل قسم قبل الانتقال إلى دروس أكثر تقدمًا. يتبع هذا الكتاب نهجًا مفاده أنه من أجل فهم الأعمال الصلبة، من الداخل والخارج، يجب عليك إنشاء كل شيء من البداية وأخذه خطوة بخطوة.",
                // Persian
    ...
    "Self-Driving Automobile Engineer": [
        // Applied Deep Learning and Computer Vision for Self-Driving Cars
        {
            ...
            "shortDescriptionsForPageBookReviewing": {
                ...
                // German
                "Deutsch": "Beginnend mit den Grundlagen selbstfahrender Autos (SDCs) führt Sie dieses Buch durch die Techniken tiefer neuronaler Netzwerke, die Sie benötigen, um mit dem Bau Ihres autonomen Fahrzeugs loszulegen. Sobald Sie mit den Grundlagen vertraut sind, vertiefen Sie sich in fortgeschrittene Computer-Vision-Techniken und lernen, wie Sie mithilfe von Deep-Learning-Methoden eine Vielzahl von Computer-Vision-Aufgaben ausführen, z. B. Fahrbahnmarkierungen finden, die Bildklassifizierung verbessern usw. Sie erkunden die grundlegende Struktur und Funktionsweise eines semantischen Segmentierungsmodells und lernen, wie man Autos mithilfe der semantischen Segmentierung erkennt. Das Buch behandelt auch fortgeschrittene Anwendungen wie Verhaltensklonen und Fahrzeugerkennung mit OpenCV, Transferlernen und Deep-Learning-Methoden, um SDCs zu trainieren, menschliches Fahren nachzuahmen.",
                // Chinese
                "中国人": "本书从自动驾驶汽车 (SDC) 的基础知识开始，带您了解构建自动驾驶汽车所需的深度神经网络技术。掌握基础知识后，您将深入研究高级计算机视觉技术，并学习如何使用深度学习方法执行各种计算机视觉任务，例如查找车道线、改进图像分类等。您将探索语义分割模型的基本结构和工作原理，并掌握使用语义分割检测汽车的方法。本书还介绍了高级应用，例如使用 OpenCV 进行行为克隆和车辆检测、迁移学习和深度学习方法，以训练 SDC 模仿人类驾驶。",
                // Russian
                "Русский": "Начиная с основ беспилотных автомобилей (SDC), эта книга познакомит вас с методами глубоких нейронных сетей, необходимыми для начала работы над созданием автономного транспортного средства. Как только вы освоитесь с основами, вы углубитесь в продвинутые методы компьютерного зрения и научитесь использовать методы глубокого обучения для выполнения различных задач компьютерного зрения, таких как поиск полос движения, улучшение классификации изображений и т. д. Вы изучите базовую структуру и работу модели семантической сегментации и научитесь обнаруживать автомобили с помощью семантической сегментации. В книге также рассматриваются передовые приложения, такие как клонирование поведения и обнаружение транспортных средств с использованием OpenCV, трансферное обучение и методологии глубокого обучения для обучения SDC имитированию вождения человека.",
                // French
                "Français": "En commençant par les bases des voitures autonomes (SDC), ce livre vous fera découvrir les techniques approfondies des réseaux neuronaux nécessaires pour être opérationnel dans la construction de votre véhicule autonome. Une fois que vous serez à l'aise avec les bases, vous découvrirez les techniques avancées de vision par ordinateur et apprendrez à utiliser les méthodes d'apprentissage en profondeur pour effectuer diverses tâches de vision par ordinateur telles que la recherche de lignes de voie, l'amélioration de la classification des images, etc. Vous explorerez la structure de base et le fonctionnement d'un modèle de segmentation sémantique et vous familiariserez avec la détection de voitures à l'aide de la segmentation sémantique. Le livre couvre également des applications avancées telles que le clonage de comportement et la détection de véhicules à l'aide d'OpenCV, l'apprentissage par transfert et les méthodologies d'apprentissage en profondeur pour former les SDC à imiter la conduite humaine.",
                // Japanese
                "日本語": "本書では、自動運転車 (SDC) の基礎から始めて、自律走行車の構築に必要なディープ ニューラル ネットワーク技術を学習します。基礎を習得したら、高度なコンピューター ビジョン技術を詳しく学習し、ディープラーニング手法を使用して、車線の検索、画像分類の改善など、さまざまなコンピューター ビジョン タスクを実行する方法を学びます。セマンティック セグメンテーション モデルの基本構造と動作を調べ、セマンティック セグメンテーションを使用した車の検出について理解します。また、OpenCV を使用した動作の複製や車両の検出、転移学習、人間の運転を模倣するように SDC をトレーニングするディープラーニング手法など、高度なアプリケーションについても説明します。",
                // Korean
                "한국인": "이 책은 자율주행차(SDC)의 기본부터 시작하여 자율주행차 제작을 시작하고 실행하는 데 필요한 심층 신경망 기술을 안내합니다. 기본 사항에 익숙해지면 고급 컴퓨터 비전 기술을 탐구하고 딥 러닝 방법을 사용하여 차선 찾기, 이미지 분류 개선 등과 같은 다양한 컴퓨터 비전 작업을 수행하는 방법을 배우게 됩니다. 의미론적 분할 모델의 기본 구조와 작동을 살펴보고 의미론적 분할을 사용하여 자동차를 감지하는 방법을 이해하게 됩니다. 또한 이 책에서는 OpenCV를 사용한 행동 복제 및 차량 감지, 전이 학습, 인간 운전을 모방하도록 SDC를 교육하는 딥 러닝 방법론과 같은 고급 애플리케이션을 다루고 있습니다.",
                // Spanish
                "Español": "Comenzando con los conceptos básicos de los vehículos autónomos (SDC), este libro lo llevará a través de las técnicas de redes neuronales profundas necesarias para comenzar a construir su vehículo autónomo. Una vez que se sienta cómodo con los conceptos básicos, profundizará en las técnicas avanzadas de visión por computadora y aprenderá a utilizar métodos de aprendizaje profundo para realizar una variedad de tareas de visión por computadora, como encontrar líneas de carril, mejorar la clasificación de imágenes, etc. Explorará la estructura básica y el funcionamiento de un modelo de segmentación semántica y se familiarizará con la detección de automóviles mediante la segmentación semántica. El libro también cubre aplicaciones avanzadas como la clonación de comportamiento y la detección de vehículos mediante OpenCV, aprendizaje por transferencia y metodologías de aprendizaje profundo para entrenar a los COSUDE para que imiten la conducción humana.",
                // Hindi
                "हिंदी": "स्व-चालित कारों (SDC) की मूल बातों से शुरू करते हुए, यह पुस्तक आपको अपने स्वायत्त वाहन के निर्माण के लिए आवश्यक डीप न्यूरल नेटवर्क तकनीकों से परिचित कराएगी। एक बार जब आप मूल बातों से परिचित हो जाते हैं, तो आप उन्नत कंप्यूटर विज़न तकनीकों में तल्लीन हो जाएँगे और लेन लाइनों को खोजने, छवि वर्गीकरण में सुधार करने आदि जैसे विभिन्न कंप्यूटर विज़न कार्यों को करने के लिए डीप लर्निंग विधियों का उपयोग करना सीखेंगे। आप सिमेंटिक सेगमेंटेशन मॉडल की मूल संरचना और कार्यप्रणाली का पता लगाएँगे और सिमेंटिक सेगमेंटेशन का उपयोग करके कारों का पता लगाने में सक्षम होंगे। पुस्तक में ओपनसीवी का उपयोग करके व्यवहार-क्लोनिंग और वाहन का पता लगाने, ट्रांसफर लर्निंग और एसडीसी को मानव ड्राइविंग की नकल करने के लिए प्रशिक्षित करने के लिए डीप लर्निंग पद्धतियों जैसे उन्नत अनुप्रयोगों को भी शामिल किया गया है।",
                // Portuguese
                "Português": "Começando com os conceitos básicos de carros autônomos (SDCs), este livro irá guiá-lo através das técnicas de redes neurais profundas necessárias para começar a construir seu veículo autônomo. Quando estiver familiarizado com o básico, você se aprofundará em técnicas avançadas de visão computacional e aprenderá como usar métodos de aprendizado profundo para executar uma variedade de tarefas de visão computacional, como encontrar linhas de pista, melhorar a classificação de imagens e assim por diante. Você explorará a estrutura básica e o funcionamento de um modelo de segmentação semântica e se familiarizará com a detecção de carros usando segmentação semântica. O livro também cobre aplicações avançadas, como clonagem de comportamento e detecção de veículos usando OpenCV, aprendizagem por transferência e metodologias de aprendizagem profunda para treinar SDCs para imitar a direção humana.",
                // Bengali
                "বাংলা": "সেলফ-ড্রাইভিং কার (SDCs) এর মূল বিষয়গুলি দিয়ে শুরু করে, এই বইটি আপনাকে আপনার স্বায়ত্তশাসিত গাড়ি তৈরির সাথে উঠতে এবং চালানোর জন্য প্রয়োজনীয় গভীর নিউরাল নেটওয়ার্ক কৌশলগুলির মাধ্যমে নিয়ে যাবে। একবার আপনি বেসিকগুলির সাথে স্বাচ্ছন্দ্য বোধ করলে, আপনি উন্নত কম্পিউটার ভিশন কৌশলগুলি অনুসন্ধান করবেন এবং কম্পিউটারের দৃষ্টিভঙ্গির বিভিন্ন কাজ যেমন লেন লাইনগুলি সন্ধান করা, চিত্রের শ্রেণিবিন্যাস উন্নত করা ইত্যাদি করতে গভীর শিক্ষার পদ্ধতিগুলি কীভাবে ব্যবহার করবেন তা শিখবেন। আপনি একটি শব্দার্থিক সেগমেন্টেশন মডেলের মৌলিক কাঠামো এবং কাজটি অন্বেষণ করবেন এবং শব্দার্থিক বিভাজন ব্যবহার করে গাড়ি সনাক্তকরণের সাথে গ্রিপ করতে পারবেন। বইটিতে উন্নত অ্যাপ্লিকেশনগুলিও অন্তর্ভুক্ত রয়েছে যেমন আচরণ-ক্লোনিং এবং ওপেনসিভি ব্যবহার করে যানবাহন সনাক্তকরণ, ট্রান্সফার লার্নিং, এবং মানব ড্রাইভিং অনুকরণ করার জন্য SDC-কে প্রশিক্ষণ দেওয়ার জন্য গভীর শিক্ষার পদ্ধতিগুলি।",
                // Arabic
                "عَرَبِيّ": "بدءًا من أساسيات السيارات ذاتية القيادة (SDC)، سيأخذك هذا الكتاب عبر تقنيات الشبكة العصبية العميقة المطلوبة للبدء في بناء سيارتك ذاتية القيادة. بمجرد أن تعتاد على الأساسيات، سوف تتعمق في تقنيات رؤية الكمبيوتر المتقدمة وتتعلم كيفية استخدام أساليب التعلم العميق لأداء مجموعة متنوعة من مهام رؤية الكمبيوتر مثل العثور على خطوط الممرات، وتحسين تصنيف الصور، وما إلى ذلك. سوف تستكشف البنية الأساسية وعمل نموذج التجزئة الدلالية وستتعرف على اكتشاف السيارات باستخدام التجزئة الدلالية. يغطي الكتاب أيضًا التطبيقات المتقدمة مثل استنساخ السلوك واكتشاف المركبات باستخدام OpenCV، ونقل التعلم، ومنهجيات التعلم العميق لتدريب مراكز تطوير البيانات (SDC) على محاكاة القيادة البشرية.",
                // Persian
...
function ResponsiveAdaptive() {
    if (window.innerWidth >= 1300) {
        ...
        // Second View
        ReadBooksListCallFunctionFunctionality(neededProperties.Currrent_Skill_Selected, neededProperties.Currrent_Language_Selected);
...
function ReadBooksListCallFunctionFunctionality(SkillName, Language) {
    ...
    if ((SkillName === "") || (SkillName === " ") || (SkillName == null)) {
        ...
        if (BooksReadForEachSkillStaticContainer[SkillName].length <= 3) {
            ...
            // Add 3 Button
        } else if (BooksReadForEachSkillStaticContainer[SkillName].length >= 10) {
            // Add ... Button
        }
    }
