...
function MakingAnythingResponsiveBehavior() {
    ...
    if (window.innerWidth >= 1300) {
        ...
        document.getElementById('first-view-main-page-background-of-div-eleement').style.background = 'url("/' + encodeURIComponent("Right Triangles and Orange Shape.svg") + '") right 20vw / 60vw no-repeat, url("/' + encodeURIComponent("Left Top - Introduction - Shapes and Perfect Triangles.svg") + '") left bottom / 60vw no-repeat, rgb(255, 255, 255)';
