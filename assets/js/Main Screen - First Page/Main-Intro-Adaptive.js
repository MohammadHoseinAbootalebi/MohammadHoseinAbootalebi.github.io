...
function MakingAnythingResponsiveBehavior() {
    ...
    //     document.getElementById('first-view-main-page-background-of-div-eleement').style.background = '"/assets/img/Right Triangles and Orange Shape.svg" right top / 30vw no-repeat, "/assets/img/Left Top - Introduction - Shapes and Perfect Triangles.svg" left bottom / 20vw no-repeat, rgb(255, 255, 255)';
    ...
    //     document.getElementById('first-view-main-page-background-of-div-eleement').style.background = '"/assets/img/Right Triangles and Orange Shape.svg" 0px 100vw / 300vw no-repeat, "/assets/img/Left Top - Introduction - Shapes and Perfect Triangles.svg" left bottom / 20vw no-repeat, rgb(255, 255, 255)';
