...
// list of properties for each skill in individual skill page
var listOfAllSkillsIndividualsSkillPage = [
    // UI & UX Designer
    {
...
// Note:
// For using the list of dictionaries you should use like this: **listOfAllSkillsIndividualsSkillPage(0).name**
...
var mainTitledTexts = {
    ...
    "English": {
        "texts": {
            "TopNavigationBarHomeButton": "Home",
            "TovNavigationBarContactMeButton": "Contact Me",
            "firstViewCTAGoToProjectsCarousel": "My Done Projects",
            "ThirdViewCarouselSlideDoneProjects": "Done Projects",
    ...
    "Deutsch": {
        "texts": {
            "TopNavigationBarHomeButton": "Heim",
            "TovNavigationBarContactMeButton": "Kontaktiere mich",
            "firstViewCTAGoToProjectsCarousel": "Meine abgeschlossenen Projekte",
            "ThirdViewCarouselSlideDoneProjects": "Abgeschlossene Projekte",
    ...
    "中国人": {
        "texts": {
            "TopNavigationBarHomeButton": "家",
            "TovNavigationBarContactMeButton": "联络我",
            "firstViewCTAGoToProjectsCarousel": "我完成的项目",
            "ThirdViewCarouselSlideDoneProjects": "已完成项目",
    ...
    "Русский": {
        "texts": {
            "TopNavigationBarHomeButton": "Дом",
            "TovNavigationBarContactMeButton": "Свяжитесь со мной",
            "firstViewCTAGoToProjectsCarousel": "Мои реализованные проекты",
            "ThirdViewCarouselSlideDoneProjects": "Готовые проекты",
    ...
    "Français": {
        "texts": {
            "TopNavigationBarHomeButton": "Maison",
            "TovNavigationBarContactMeButton": "Contactez Moi",
            "firstViewCTAGoToProjectsCarousel": "Mes projets terminés",
            "ThirdViewCarouselSlideDoneProjects": "Projets terminés",
    ...
    "日本語": {
        "texts": {
            "TopNavigationBarHomeButton": "家",
            "TovNavigationBarContactMeButton": "私に連絡して",
            "firstViewCTAGoToProjectsCarousel": "私の完了したプロジェクト",
            "ThirdViewCarouselSlideDoneProjects": "完了したプロジェクト",
    ...
    "한국인": {
        "texts": {
            "TopNavigationBarHomeButton": "집",
            "TovNavigationBarContactMeButton": "저에게 연락하세요",
            "firstViewCTAGoToProjectsCarousel": "내가 완료한 프로젝트",
            "ThirdViewCarouselSlideDoneProjects": "완료된 프로젝트",
    ...
    "Español": {
        "texts": {
            "TopNavigationBarHomeButton": "Hogar",
            "TovNavigationBarContactMeButton": "Contáctame",
            "firstViewCTAGoToProjectsCarousel": "Mis proyectos realizados",
            "ThirdViewCarouselSlideDoneProjects": "Proyectos realizados",
    ...
    "हिंदी": {
        "texts": {
            "TopNavigationBarHomeButton": "घर",
            "TovNavigationBarContactMeButton": "मुझसे संपर्क करें",
            "firstViewCTAGoToProjectsCarousel": "मेरे पूर्ण प्रोजेक्ट",
            "ThirdViewCarouselSlideDoneProjects": "पूर्ण परियोजनाएँ",
    ...
    "Português": {
        "texts": {
            "TopNavigationBarHomeButton": "Lar",
            "TovNavigationBarContactMeButton": "Contate Me",
            "firstViewCTAGoToProjectsCarousel": "Meus projetos concluídos",
            "ThirdViewCarouselSlideDoneProjects": "Projetos concluídos",
    ...
    "বাংলা": {
        "texts": {
            "TopNavigationBarHomeButton": "বাড়ি",
            "TovNavigationBarContactMeButton": "আমার সাথে যোগাযোগ কর",
            "firstViewCTAGoToProjectsCarousel": "আমার সম্পন্ন প্রকল্প",
            "ThirdViewCarouselSlideDoneProjects": "সম্পন্ন প্রকল্প",
    ...
    "عَرَبِيّ": {
        "texts": {
            "TopNavigationBarHomeButton": "بيت",
            "TovNavigationBarContactMeButton": "اتصل بي",
            "firstViewCTAGoToProjectsCarousel": "مشاريعي المنجزة",
            "ThirdViewCarouselSlideDoneProjects": "المشاريع المنجزة",
    ...
    "فارسی": {
        "texts": {
            "TopNavigationBarHomeButton": "خانه",
            "TovNavigationBarContactMeButton": "تماس با من",
            "firstViewCTAGoToProjectsCarousel": "پروژه های من",
            "ThirdViewCarouselSlideDoneProjects": "پروژه های انجام شده",
...
var neededProperties = {
    ...
    _translations_first_view_introduction_Text: "",

    get translationsFirstViewIntroductionTextParagraph() {
        return this._translations_first_view_introduction_Text;
    },

    set translationsFirstViewIntroductionTextParagraph(newSkill) {
        // Chnaging the main text paragraph of the first view of the individual view of each skill
        document.getElementById('MainTextIndividualSkillParagraphIntroduction').textContent = individualSkillsDescriptionsSecondhierachy[neededProperties._current_show_language]["FirstIntroFirstViewDescription"][neededProperties._current_skill_selected];
    ...
    set currentSkillSelected(newSkill) {
        ...
        window.addEventListener('resize', function () {
            ...
            if (this.window.innerWidth < 972) {
                ...
                document.getElementById('MainTextIndividualSkillParagraphIntroduction').style.fontSize = '2vmin';
                ...
                document.getElementById('MainTextIndividualSkillParagraphIntroduction').style.fontSize = '3vmin';
            }
            else {
        ...
        // ------- ↓ Showing the Individual Skills Page Software Skills Percentages ↓ -------

        for (var skilldex = 0; skilldex < listOfAllSkillsIndividualsSkillPage.length; skilldex++) {

            // finding the current skill properties
            if (listOfAllSkillsIndividualsSkillPage[skilldex].skillName == newSkill) {
                ...
                titleOfSoftwareSkills.className = "row row-cols-1 d-xxl-flex justify-content-center justify-content-xxl-center";
                titleOfSoftwareSkills.style = "margin-top: 14px;margin-bottom: 14px;";
                titleOfSoftwareSkills.id = titleOfSoftwareSkills.className + "individual-skill-page-software-skills-" + skilldex.toString() + "-" + skilldex.toString();
                document.getElementById('first-view-individual-skill-page-active-items').appendChild(titleOfSoftwareSkills); // Adding to the carousel items active

                // creating the inside div of software skills
                var colOfTitleOfSoftwareSkills = document.createElement('div');
                colOfTitleOfSoftwareSkills.className = "col";
                colOfTitleOfSoftwareSkills.id = "Individual-skill-page-software-skilss-Inner-Column-of-" + skilldex.toString() + "-" + skilldex.toString();
                document.getElementById(titleOfSoftwareSkills.id).appendChild(colOfTitleOfSoftwareSkills);

                // Software skills title
                var headerOfSofwareSkills = document.createElement('h1');
                headerOfSofwareSkills.className = "fw-bold d-xxl-flex justify-content-xxl-center align-items-xxl-center mb-3";
                headerOfSofwareSkills.style = "font-family: 'Lilita One', serif;color: rgb(252,163,17);text-align: center;";
                headerOfSofwareSkills.textContent = "Software Skills";
                document.getElementById(colOfTitleOfSoftwareSkills.id).appendChild(headerOfSofwareSkills);

                for (var index = 0; index < limitOfSofwaresSkillsToShowToCount; index++) {
                    // Creating the first div
                    var firstDiv = document.createElement('div');
                    firstDiv.className = "row row-cols-1 d-xxl-flex justify-content-center justify-content-xxl-center";
                    firstDiv.style = "margin-top: 14px;margin-bottom: 14px;";
                    firstDiv.id = "second-view-firstDiv-softwares-SKILLS-" + skilldex.toString() + (index + skilldex).toString();
                    document.getElementById(activeCarouselItemsDiv.id).appendChild(firstDiv);
                    ...
                    var secondDivImg = document.createElement('img');
                    secondDivImg.src = listOfAllSkillsIndividualsSkillPage[skilldex].softwarePercentages[index].imgURL;
                    secondDivImg.style = "padding-right: 20px;width: 3.5em;";
                    document.getElementById(secondDiv.id).appendChild(secondDivImg);

                    // creating the third div
                    var thirdDiv = document.createElement('div');
                    thirdDiv.className = "d-xxl-flex align-items-xxl-start progress";
                    thirdDiv.style = "width: 100px;";
                    thirdDiv.id = "second-view-thirdDiv-softwares-SKILLS-" + skilldex.toString() + (index + skilldex).toString();
                    document.getElementById(secondDiv.id).appendChild(thirdDiv);

                    // creating the fourth div
                    var fourthDiv = document.createElement('div');
                    fourthDiv.className = "progress-bar";
                    fourthDiv.role = "progressbar";
                    fourthDiv.ariaValueNow = listOfAllSkillsIndividualsSkillPage[skilldex].softwarePercentages[index].percentageNumber.toString();
                    fourthDiv.style = "width: 70%;height: 32px;background: #fca311;";
                    fourthDiv.id = "second-view-fourthDiv-softwares-SKILLS-" + skilldex.toString() + (index + skilldex).toString();
                    document.getElementById(thirdDiv.id).appendChild(fourthDiv);

                    // Creating the paragraph show
                    var paragraphShowPercentage = document.createElement('p');
                    paragraphShowPercentage.style = "color: #000000;background: rgba(252,163,17,0);width: 120%;";
                    paragraphShowPercentage.textContent = listOfAllSkillsIndividualsSkillPage[skilldex].softwarePercentages[index].percentageNumber.toString() + "% ";
                    document.getElementById(fourthDiv.id).appendChild(paragraphShowPercentage);
                }

                // carousel item active indicator
                var firstDivIndicator = document.createElement('button');
                firstDivIndicator.className = "active";
                ...
                var counter = 1; var slideIndexr = 1;
                // Creating the first carousel item
                ...
                //     carauselItemsContainer.style = "margin-top: 10vw;";
                // } else {
                //     carauselItemsContainer.style = "margin-top: 40vh;";
                // }
                ...
                titleOfSoftwareSkills.className = "row row-cols-1 d-xxl-flex justify-content-center justify-content-xxl-center";
                titleOfSoftwareSkills.style = "margin-top: 14px;margin-bottom: 14px;";
                titleOfSoftwareSkills.id = titleOfSoftwareSkills.className + "-individual-skill-page-software-skills-slide-" + (counter + 1).toString() + "-" + (counter + 1).toString();
                document.getElementById(carauselItemsContainer.id).appendChild(titleOfSoftwareSkills); // Adding to the carousel items active

                // creating the inside div of software skills
                var colOfTitleOfSoftwareSkills = document.createElement('div');
                colOfTitleOfSoftwareSkills.className = "col";
                colOfTitleOfSoftwareSkills.id = "Individual-skill-page-software-skilss-Inner-Column-of-" + (counter + skilldex).toString() + "-" + (counter + skilldex).toString();
                document.getElementById(titleOfSoftwareSkills.id).appendChild(colOfTitleOfSoftwareSkills);

                // Software skills title
                var headerOfSofwareSkills = document.createElement('h1');
                headerOfSofwareSkills.className = "fw-bold d-xxl-flex justify-content-xxl-center align-items-xxl-center mb-3";
                headerOfSofwareSkills.style = "font-family: 'Lilita One', serif;color: rgb(252,163,17);font-size: 5vmin;text-align: center;";
                headerOfSofwareSkills.textContent = "Software Skills";
                document.getElementById(colOfTitleOfSoftwareSkills.id).appendChild(headerOfSofwareSkills);
                ...
                firstDivIndicator.type = "button";
                firstDivIndicator.dataset.bsTarget = "#software-skills";
                firstDivIndicator.dataset.bsSlideTo = slideIndexr.toString();
                document.getElementById("second-view-individual-skills-table-of-contents-second-view-carousel-indicator-div").appendChild(firstDivIndicator);

                for (var index = 5; index < listOfAllSkillsIndividualsSkillPage[skilldex].softwarePercentages.length; index++) {

                    // Checking whether the is getting to the 5s or not
                    if (counter % 6 == 0) {
                        ...
                        firstDiv.className = "row row-cols-1 d-xxl-flex justify-content-center justify-content-xxl-center";
                        firstDiv.style = "margin-top: 14px;margin-bottom: 14px;";
                        firstDiv.id = "slides-of-individual-skill-page-percentages-of-software-skills-first-div-slide-" + (counter + 1).toString() + "-software-number-" + index.toString();
                        document.getElementById(carauselItemsContainer.id).appendChild(firstDiv);
                        ...
                        thirdDiv.className = "d-xxl-flex align-items-xxl-start progress";
                        thirdDiv.style = "width: 100px;";
                        thirdDiv.id = "slides-of-individual-skill-page-percentages-of-software-skills-third-div-slide-" + (counter + 1).toString() + "-software-number-" + index.toString();
                        document.getElementById(secondDiv.id).appendChild(thirdDiv);
                        ...
                        fourthDiv.ariaValueNow = listOfAllSkillsIndividualsSkillPage[skilldex].softwarePercentages[index].percentageNumber.toString();
                        fourthDiv.style = "width: 70%;height: 32px;background: #fca311;";
                        fourthDiv.id = "slides-of-individual-skill-page-percentages-of-software-skills-fourth-div-slide-" + (counter + 1).toString() + "-software-number-" + index.toString();
                        document.getElementById(thirdDiv.id).appendChild(fourthDiv);
    ...
    set currentShowLanguage(newLanguage) {
        ...
        dropdownToggle.style.fontFamily = downloadMyResumeTranslations[newLanguage]['fontFamily'];

        // Navigation Bar
        // - > Home
        document.querySelector('#navigation-top-bar-home-link-to-go-to-the-home-page > a').textContent = mainTitledTexts[newLanguage]['texts']['TopNavigationBarHomeButton'];
        document.querySelector('#navigation-top-bar-home-link-to-go-to-the-home-page > a').style.fontFamily = mainTitledTexts[newLanguage]['fontFamily'];
        // - > Download Resume Nav Bar link
        ...
        // - > Contact Me Button
        document.getElementById('contact-me-nav-bar').textContent = mainTitledTexts[newLanguage]['texts']['TovNavigationBarContactMeButton'];
        document.getElementById('contact-me-nav-bar').style.fontFamily = mainTitledTexts[newLanguage]['fontFamily'];
        ...
        // - > Done Project Title
        document.getElementById('third-view-done-projects-done-projects-title-slide').textContent = mainTitledTexts[newLanguage]['texts']['ThirdViewCarouselSlideDoneProjects'];
        document.getElementById('third-view-done-projects-done-projects-title-slide').style.fontFamily = mainTitledTexts[newLanguage]['fontFamily'];

        // - > Passed Courses Title
        document.getElementById('third-view-done-projects-passed-courses-title-slide').textContent = mainTitledTexts[newLanguage]['texts']['ThirdViewCarouselSlidePassedCourses'];
        document.getElementById('third-view-done-projects-passed-courses-title-slide').style.fontFamily = mainTitledTexts[newLanguage]['fontFamily'];

        // - > Read Books Title
        document.getElementById('third-view-done-projects-read-books-title-slide').textContent = mainTitledTexts[newLanguage]['texts']['ThirdViewCarouselSlideReadBooks'];
        document.getElementById('third-view-done-projects-read-books-title-slide').style.fontFamily = mainTitledTexts[newLanguage]['fontFamily'];

        // - > Project Card description
        document.getElementById('third-view-projects-card-carasousel-paragraph-description').textContent = individualSkillsDescriptionsSecondhierachy[newLanguage]['ThirdViewProjectSlideParagraphShortDescription'][neededProperties._current_skill_selected];
        document.getElementById('third-view-projects-card-carasousel-paragraph-description').style.fontFamily = individualSkillsDescriptionsSecondhierachy[newLanguage]["fontFamily"];

        // - > Passed Course Description
        document.getElementById('third-view-Courses-passed-card-carasousel-paragraph-description').textContent = individualSkillsDescriptionsSecondhierachy[newLanguage]['ThirdViewCourcesWatchedSlideParagraphShortDescription'][neededProperties._current_skill_selected];
        document.getElementById('third-view-Courses-passed-card-carasousel-paragraph-description').style.fontFamily = individualSkillsDescriptionsSecondhierachy[newLanguage]["fontFamily"];

        // - > Read Books Description
        document.getElementById('third-view-read-books-card-carasousel-paragraph-description').textContent = individualSkillsDescriptionsSecondhierachy[newLanguage]['ThirdViewReadBooksWatchedSlideParagraphShortDescription'][neededProperties._current_skill_selected];
        document.getElementById('third-view-read-books-card-carasousel-paragraph-description').style.fontFamily = individualSkillsDescriptionsSecondhierachy[newLanguage]["fontFamily"];

        // - > See More Button
        document.querySelectorAll('#third-view-caraousel-slides-go-to-more > div > div > div > div > a').forEach(
            function (item) {
                item.textContent = mainTitledTexts[newLanguage]['texts']['ThirdViewCarouselSlideSeeMoreButton'];
                item.style.fontFamily = mainTitledTexts[newLanguage]['fontFamily'];
            }
        );
        ...
        if ((newLanguage == "فارسی") || (newLanguage == "عَرَبِيّ")) {
            ...
            // First View
            // - > Title
            document.getElementById('first-view-header-introduction-skill-individual-skill-name').style.textAlign = "end";
            // - > Description Paragraph
            document.getElementById('MainTextIndividualSkillParagraphIntroduction').style.textAlign = "start";
            document.getElementById('MainTextIndividualSkillParagraphIntroduction').dir = "rtl";
            // - > CTA Go to Project Button
            document.getElementById('CTA-button-first-view-individual-skills-intro-div-element').align = "right";

            // Third View
            // - > Total view
            document.querySelectorAll('#third-view-div-element-totally').forEach(function (item) { item.align = "right"; });
            // - > Description Paragraph
            document.querySelectorAll('#third-view-div-element-totally > p').forEach(function (item) { item.dir = "rtl"; item.textAlign = "start"; });

            // Fourth View
            // - > Let's Talk Title
            document.getElementById('let-s-talk-third-section-the-contact-informations').style.textAlign = "start";
            document.getElementById('let-s-talk-third-section-the-contact-informations').dir = "rtl";
            // - > All rights reserved
            document.getElementById('all-rights-reserved-copy-right-symbol-paragraph-muhammad-husain-aboutalebi-all-right-reserved').style.textAlign = "start";
            document.getElementById('all-rights-reserved-copy-right-symbol-paragraph-muhammad-husain-aboutalebi-all-right-reserved').dir = "rtl";

        } else {

            // First View
            // - > Title
            document.getElementById('first-view-header-introduction-skill-individual-skill-name').style.textAlign = "start";
            // - > Description Paragraph
            document.getElementById('MainTextIndividualSkillParagraphIntroduction').style.textAlign = "start";
            document.getElementById('MainTextIndividualSkillParagraphIntroduction').dir = "ltr";
            // - > CTA Go to Project Button
            document.getElementById('CTA-button-first-view-individual-skills-intro-div-element').align = "left";

            // Third View
            // - > Total view
            document.querySelectorAll('#third-view-div-element-totally').forEach(function (item) { item.align = "left"; });
            // - > Description Paragraph
            document.querySelectorAll('#third-view-div-element-totally > p').forEach(function (item) { item.dir = "ltr"; item.textAlign = "start"; });

            // Fourth View
            // - > Let's Talk Title
            document.getElementById('let-s-talk-third-section-the-contact-informations').style.textAlign = "start";
            document.getElementById('let-s-talk-third-section-the-contact-informations').dir = "ltr";
            // - > All rights reserved
            document.getElementById('all-rights-reserved-copy-right-symbol-paragraph-muhammad-husain-aboutalebi-all-right-reserved').style.textAlign = "start";
            document.getElementById('all-rights-reserved-copy-right-symbol-paragraph-muhammad-husain-aboutalebi-all-right-reserved').dir = "ltr";
        ...
        // Chaning the intro font style
        document.getElementById('MainTextIndividualSkillParagraphIntroduction').style.fontFamily = individualSkillsDescriptionsSecondhierachy[newLanguage]["fontFamily"];
        ...
        return this._current_show_language = newLanguage;
...
if (lanauge_show) {
    if (headerText) {
        neededProperties.currentShowLanguage = decodeURIComponent(lanauge_show);
        neededProperties.currentSkillSelected = decodeURIComponent(headerText);
        neededProperties.translationsFirstViewIntroductionTextParagraph = "";
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById('download-my-resume-pdf-id-tag-button-link').textContent = downloadMyResumeTranslations[neededProperties._current_show_language]['text'];
    document.getElementById('download-my-resume-pdf-id-tag-button-link').style.fontFamily = downloadMyResumeTranslations[neededProperties._current_show_language]['fontFamily'];
    ...
    Array.from(dropdownItems).forEach(function (item) {
        ...
        item.addEventListener('click', function (event) {
            ...
            neededProperties.currentShowLanguage = this.textContent;
            neededProperties.translationsFirstViewIntroductionTextParagraph = "";
        });
    });
});
...
function individualSkillFirstViewIntroFirtView() {
    ResponsiveViewIndividualView();

    // For just Customizations
    // First View
    // - > Intro Paragraph
    document.getElementById('MainTextIndividualSkillParagraphIntroduction').style.fontFamily = individualSkillsDescriptionsSecondhierachy[neededProperties._current_show_language]["fontFamily"];
    ...
    // - > Done Project Title
    document.getElementById('third-view-done-projects-done-projects-title-slide').textContent = mainTitledTexts[neededProperties._current_show_language]['texts']['ThirdViewCarouselSlideDoneProjects'];
    document.getElementById('third-view-done-projects-done-projects-title-slide').style.fontFamily = mainTitledTexts[neededProperties._current_show_language]['fontFamily'];

    // - > Passed Courses Title
    document.getElementById('third-view-done-projects-passed-courses-title-slide').textContent = mainTitledTexts[neededProperties._current_show_language]['texts']['ThirdViewCarouselSlidePassedCourses'];
    document.getElementById('third-view-done-projects-passed-courses-title-slide').style.fontFamily = mainTitledTexts[neededProperties._current_show_language]['fontFamily'];

    // - > Read Books Title
    document.getElementById('third-view-done-projects-read-books-title-slide').textContent = mainTitledTexts[neededProperties._current_show_language]['texts']['ThirdViewCarouselSlideReadBooks'];
    document.getElementById('third-view-done-projects-read-books-title-slide').style.fontFamily = mainTitledTexts[neededProperties._current_show_language]['fontFamily'];

    // - > Project Card description
    document.getElementById('third-view-projects-card-carasousel-paragraph-description').textContent = individualSkillsDescriptionsSecondhierachy[neededProperties._current_show_language]['ThirdViewProjectSlideParagraphShortDescription'][neededProperties._current_skill_selected];
    document.getElementById('third-view-projects-card-carasousel-paragraph-description').style.fontFamily = individualSkillsDescriptionsSecondhierachy[neededProperties._current_show_language]["fontFamily"];

    // - > Passed Course Description
    document.getElementById('third-view-Courses-passed-card-carasousel-paragraph-description').textContent = individualSkillsDescriptionsSecondhierachy[neededProperties._current_show_language]['ThirdViewCourcesWatchedSlideParagraphShortDescription'][neededProperties._current_skill_selected];
    document.getElementById('third-view-Courses-passed-card-carasousel-paragraph-description').style.fontFamily = individualSkillsDescriptionsSecondhierachy[neededProperties._current_show_language]["fontFamily"];

    // - > Read Books Description
    document.getElementById('third-view-read-books-card-carasousel-paragraph-description').textContent = individualSkillsDescriptionsSecondhierachy[neededProperties._current_show_language]['ThirdViewReadBooksWatchedSlideParagraphShortDescription'][neededProperties._current_skill_selected];
    document.getElementById('third-view-read-books-card-carasousel-paragraph-description').style.fontFamily = individualSkillsDescriptionsSecondhierachy[neededProperties._current_show_language]["fontFamily"];

    // - > See More Button
    document.querySelectorAll('#third-view-caraousel-slides-go-to-more > div > div > div > div > a').forEach(
        function (item) {
            item.textContent = mainTitledTexts[neededProperties._current_show_language]['texts']['ThirdViewCarouselSlideSeeMoreButton'];
            item.style.fontFamily = mainTitledTexts[neededProperties._current_show_language]['fontFamily'];
        }
    );
...
function ResponsiveViewIndividualView() {
    // Responsive Views
    if (window.innerWidth >= 1300) {
        // Top Navigation Bar
        ...
        // First View
        // - > Background
        document.getElementById('detail-introduction-first-screen').style.background = "linear-gradient(90deg, rgba(0,0,0,0.1) 0%, rgba(0,0,0,1) 40%, rgba(0,0,0,0) 50%), url('/assets/img/Detail Skills Page - Second Page/Perfect Shape Triangles.svg') -1vw 1vw / 50vw no-repeat, linear-gradient(90deg, rgba(0,0,0,1) 0%, rgba(0,0,0,1) 45%, rgba(0,0,0,0.3) 100%), " + "url('" + neededProperties._current_skill_image_intro_background + "') " + " top right / 56vw no-repeat";
        // - > Skill Title
        document.getElementById('first-view-header-introduction-skill-individual-skill-name').style.fontSize = "3.5vw";
        document.getElementById('first-view-header-introduction-skill-individual-skill-name').style.width = "65vw";
        document.getElementById('first-view-header-introduction-skill-individual-skill-name').style.marginTop = "-10vw";
        document.getElementById('first-view-header-introduction-skill-individual-skill-name').style.marginLeft = "1vw";
        // - > Intro Paragroph
        document.getElementById('MainTextIndividualSkillParagraphIntroduction').style.fontSize = "1.6vw";
        document.getElementById('MainTextIndividualSkillParagraphIntroduction').style.width = "65vw";
        document.getElementById('MainTextIndividualSkillParagraphIntroduction').style.marginLeft = "1vw";
        // - > CTA Go to Project Button
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.fontSize = "1.4vw";
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.paddingLeft = "1.5vw";
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.paddingRight = "1.5vw";
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.paddingTop = "0.8vw";
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.paddingBottom = "0.8vw";
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.borderRadius = "14px";
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.width = "auto";
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.borderRadius = "10px";
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.marginLeft = "1vw";
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.marginRight = "0vw";
        // - > Mouse Indicator
        document.getElementById('scroll-mouse-direction-down-animation-detail-skill-view').style.opacity = "0";

        // Second View
        // - > Carousel
        document.getElementById('software-skills').style.height = "40vw";
        document.getElementById('software-skills').style.marginTop = "10vw";
        document.getElementById('software-skills').style.marginBottom = "10vw";
        // - > Background
        document.getElementById('software-skills').style.background = "linear-gradient(90deg, rgba(0,0,0,1) 0%, rgba(0,0,0,1) 50%, rgba(0,0,0,0.6783088235294117) 70%, rgba(0,0,0,0) 100%), url('/assets/img/Detail Skills Page - Second Page/Perfect Circles.svg') right / 40vw no-repeat";
        // - > Slide fontsize
        document.querySelectorAll('#slides-of-individual-skill-page-percentages-of-software-skills > div > div > div > h1').forEach(
            function (item) {
        ...
        // Third View
        // - > Carousel Height
        document.getElementById('third-view-projects-cources-books').style.height = "50vw";
        // - > Background
        document.getElementById('third-view-projects-cources-books').style.background = "linear-gradient(90deg, rgba(0,0,0,0), rgba(0,0,0,0.8) 26%, rgb(0,0,0) 50%, rgba(0,0,0,0.7) 91%, rgba(0,0,0,0)), url('/assets/img/Perfect Triangles 30 Rotated.png') 40vw -10VW / 60vw no-repeat, url('/assets/img/Perfect Shape Triangles.svg') -1vw -10vw / 60vw no-repeat";
        // - > Each Book, Course, Project Titles
        document.querySelectorAll('#third-view-projects-cources-books > div > div > div > div > div > div > h1').forEach(
            function (item) {
                item.style.width = "30vw";
                item.style.fontSize = "3.5vw";
                item.style.paddingBottom = "1vw";
                item.style.paddingRight = "3vw";
                item.style.marginTop = "8vw";
            }
        );
        // - > Short Paragraph
        document.querySelectorAll('#third-view-projects-cources-books > div > div > div > div > div > div > p').forEach(
            function (item) {
                item.style.width = "40vw";
                item.style.fontSize = "1.6vw";
                item.style.paddingBottom = "2.5vw";
                item.style.paddingRight = "3vw";
            }
        );
        // - > Anchor Links
        document.querySelectorAll('#third-view-projects-cources-books > div > div > div > div > div > div > a').forEach(
            function (item) {
                item.style.fontSize = "1.6vw";
                item.style.marginRight = "3vw";
                item.style.borderRadius = "14px";
            }
        );
        // - > Images
        document.querySelectorAll('#third-view-projects-cources-books > div > div > div > div > div > img').forEach(
            function (item) {
                item.style.width = "30vw";
                item.style.height = "30vw";
                item.style.borderRadius = "60px";
                item.style.marginRight = "-14vw";
        ...
        document.getElementById('detail-introduction-first-screen').style.background = "linear-gradient(90deg, rgba(0,0,0,0.1) 0%, rgba(0,0,0,1) 40%, rgba(0,0,0,0) 50%), url('/assets/img/Detail Skills Page - Second Page/Perfect Shape Triangles.svg') -1vw 1vw / 50vw no-repeat, linear-gradient(90deg, rgba(0,0,0,1) 0%, rgba(0,0,0,1) 45%, rgba(0,0,0,0.3) 100%), " + "url('" + neededProperties._current_skill_image_intro_background + "') " + " top right / 56vw no-repeat";
        // - > Skill Title
        document.getElementById('first-view-header-introduction-skill-individual-skill-name').style.fontSize = "5vw";
        document.getElementById('first-view-header-introduction-skill-individual-skill-name').style.width = "65vw";
        document.getElementById('first-view-header-introduction-skill-individual-skill-name').style.marginTop = "-10vw";
        document.getElementById('first-view-header-introduction-skill-individual-skill-name').style.marginLeft = "-15vw";
        // - > Intro Paragroph
        document.getElementById('MainTextIndividualSkillParagraphIntroduction').style.fontSize = "2vw";
        document.getElementById('MainTextIndividualSkillParagraphIntroduction').style.width = "65vw";
        document.getElementById('MainTextIndividualSkillParagraphIntroduction').style.marginLeft = "-15vw";
        // - > CTA Go to Project Button
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.fontSize = "1.5vw";
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.width = "auto";
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.borderRadius = "10px";
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.marginLeft = "-15vw";
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.marginRight = "0vw";
        // - > Mouse Indicator
        document.getElementById('scroll-mouse-direction-down-animation-detail-skill-view').style.opacity = "0";
        ...
        // First View
        // - > Background
        document.getElementById('detail-introduction-first-screen').style.background = "linear-gradient(90deg, rgba(0,0,0,0.1) 0%, rgba(0,0,0,1) 40%, rgba(0,0,0,0) 50%), url('/assets/img/Detail Skills Page - Second Page/Perfect Shape Triangles.svg') -1vw 10vw / 50vw no-repeat, linear-gradient(90deg, rgba(0,0,0,1) 0%, rgba(0,0,0,1) 45%, rgba(0,0,0,0.3) 100%), " + "url('" + neededProperties._current_skill_image_intro_background + "') " + " top right / 65vw no-repeat";
        // - > Skill Title
        document.getElementById('first-view-header-introduction-skill-individual-skill-name').style.fontSize = "5vw";
        document.getElementById('first-view-header-introduction-skill-individual-skill-name').style.width = "65vw";
        document.getElementById('first-view-header-introduction-skill-individual-skill-name').style.marginTop = "-10vw";
        ...
        document.getElementById('MainTextIndividualSkillParagraphIntroduction').style.marginLeft = "-15vw";
        // - > CTA Go to Project Button
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.fontSize = "2vw";
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.width = "auto";
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.borderRadius = "10px";
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.marginLeft = "-15vw";
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.marginRight = "0vw";
        ...
        // Second View
        // - > Carousel
        document.getElementById('software-skills').style.height = "50vw";
        document.getElementById('software-skills').style.marginTop = "8vw";
        document.getElementById('software-skills').style.marginBottom = "8vw";
        // - > Background
        document.getElementById('software-skills').style.background = "linear-gradient(90deg, rgba(0,0,0,1) 0%, rgba(0,0,0,1) 50%, rgba(0,0,0,0.6783088235294117) 70%, rgba(0,0,0,0) 100%), url('/assets/img/Detail Skills Page - Second Page/Perfect Circles.svg') right / 40vw no-repeat";
        // - > Slide fontsize
        document.querySelectorAll('#slides-of-individual-skill-page-percentages-of-software-skills > div > div > div > h1').forEach(
        ...
        // Third View
        // - > Carousel Height
        document.getElementById('third-view-projects-cources-books').style.height = "60vw";
        // - > Background
        document.getElementById('third-view-projects-cources-books').style.background = "linear-gradient(90deg, rgba(0,0,0,0), rgba(0,0,0,0.8) 26%, rgb(0,0,0) 50%, rgba(0,0,0,0.7) 91%, rgba(0,0,0,0)), url('/assets/img/Perfect Triangles 30 Rotated.png') 42vw -10VW / 60vw no-repeat, url('/assets/img/Perfect Shape Triangles.svg') -1vw 1vw / 60vw no-repeat";
        // - > Each Book, Course, Project Titles
        document.querySelectorAll('#third-view-projects-cources-books > div > div > div > div > div > div > h1').forEach(
            function (item) {
                item.style.fontSize = "5vw";
        ...
        // Second View
        // - > Carousel
        document.getElementById('software-skills').style.height = "65vw";
        // - > Background
        document.getElementById('software-skills').style.background = "linear-gradient(90deg, rgba(0,0,0,1) 0%, rgba(0,0,0,1) 50%, rgba(0,0,0,0.6783088235294117) 70%, rgba(0,0,0,0) 100%), url('/assets/img/Detail Skills Page - Second Page/Perfect Circles.svg') right / 50vw no-repeat";
        // - > Slide fontsize
        document.querySelectorAll('#slides-of-individual-skill-page-percentages-of-software-skills > div > div > div > h1').forEach(
            function (item) {
                item.style.fontSize = "5vw";
        ...
        // Third View
        // - > Carousel Height
        document.getElementById('third-view-projects-cources-books').style.height = "90vw";
        // - > Background
        document.getElementById('third-view-projects-cources-books').style.background = "linear-gradient(90deg, rgba(0,0,0,0), rgba(0,0,0,0.8) 26%, rgb(0,0,0) 50%, rgba(0,0,0,0.7) 91%, rgba(0,0,0,0)), url('/assets/img/Perfect Triangles 30 Rotated.png') 42vw -10VW / 60vw no-repeat, url('/assets/img/Perfect Shape Triangles.svg') -1vw 30vw / 60vw no-repeat";
        // - > Each Book, Course, Project Titles
        document.querySelectorAll('#third-view-projects-cources-books > div > div > div > div > div > div > h1').forEach(
            function (item) {
                item.style.fontSize = "5vw";
        ...
        // First View
        // - > Background
        document.getElementById('detail-introduction-first-screen').style.background = "linear-gradient(180deg, rgba(0,0,0,0.5) 0%, rgba(0,0,0,0.99) 75%, rgb(0,0,0, 0.5) 80%, rgba(0, 0, 0, 0.1) 0%, rgba(0, 0, 0, 0.7) 40%), " + "url('" + neededProperties._current_skill_image_intro_background + "') " + " top / 100vw no-repeat";
        // - > Skill Title
        document.getElementById('first-view-header-introduction-skill-individual-skill-name').style.fontSize = "7vw";
        document.getElementById('first-view-header-introduction-skill-individual-skill-name').style.width = "65vw";
        document.getElementById('first-view-header-introduction-skill-individual-skill-name').style.marginTop = "-40vw";
        document.getElementById('first-view-header-introduction-skill-individual-skill-name').style.marginLeft = "-15vw";
        // - > Intro Paragroph
        document.getElementById('MainTextIndividualSkillParagraphIntroduction').style.fontSize = "3vw";
        document.getElementById('MainTextIndividualSkillParagraphIntroduction').style.width = "65vw";
        document.getElementById('MainTextIndividualSkillParagraphIntroduction').style.marginLeft = "-15vw";
        // - > CTA Go to Project Button
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.fontSize = "3vw";
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.width = "auto";
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.borderRadius = "10px";
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.marginLeft = "-15vw";
        // - > Mouse Indicator
        ...
        // Second View
        // - > Carousel
        document.getElementById('software-skills').style.height = "130vw";
        // - > Background
        document.getElementById('software-skills').style.background = "linear-gradient(90deg, black, rgba(0,0,0,0.9) 20%, rgba(0,0,0,0.6)), url('/assets/img/Detail Skills Page - Second Page/Perfect Circles.svg') right / 100vw no-repeat";
        // - > Slide fontsize
        document.querySelectorAll('#slides-of-individual-skill-page-percentages-of-software-skills > div > div > div > h1').forEach(
            function (item) {
                item.style.fontSize = "8vw";
                item.style.marginTop = "40vw";
            }
        );

        // Third View
        // - > Background
        document.getElementById('third-view-projects-cources-books').style.background = "linear-gradient(90deg, rgba(0,0,0,0), rgba(0,0,0,0.8) 26%, rgb(0,0,0) 50%, rgba(0,0,0,0.7) 91%, rgba(0,0,0,0)), url('/assets/img/Perfect Triangles 30 Rotated.png') 40vw -10VW / 102vmin no-repeat, url('/assets/img/Perfect Shape Triangles.svg') -30vw 30vw / 100vw no-repeat";
        // - > Each Book, Course, Project Titles
        document.querySelectorAll('#third-view-projects-cources-books > div > div > div > div > div > div > h1').forEach(
            function (item) {
                item.style.fontSize = "7vw";
        ...
        // First View
        // - > Background
        document.getElementById('detail-introduction-first-screen').style.background = "linear-gradient(180deg, rgba(0,0,0,0.3) 5%, rgba(0,0,0,0.99) 50%, rgb(0,0,0, 1) 60%, rgba(0, 0, 0, 1) 30%, rgba(0, 0, 0, 0.7) 30%), url('/assets/img/Detail Skills Page - Second Page/Perfect Shape Triangles.svg') bottom / contain no-repeat, " + "url('" + neededProperties._current_skill_image_intro_background + "') " + " top / contain no-repeat";
        // - > Skill Title
        document.getElementById('first-view-header-introduction-skill-individual-skill-name').style.fontSize = "8vw";
        document.getElementById('first-view-header-introduction-skill-individual-skill-name').style.width = "65vw";
        document.getElementById('first-view-header-introduction-skill-individual-skill-name').style.marginTop = "-40vw";
        document.getElementById('first-view-header-introduction-skill-individual-skill-name').style.marginLeft = "-15vw";
        // - > Intro Paragroph
        document.getElementById('MainTextIndividualSkillParagraphIntroduction').style.fontSize = "4vw";
        document.getElementById('MainTextIndividualSkillParagraphIntroduction').style.width = "65vw";
        document.getElementById('MainTextIndividualSkillParagraphIntroduction').style.marginLeft = "-15vw";
        // - > CTA Go to Project Button
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.fontSize = "4vw";
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.width = "auto";
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.borderRadius = "10px";
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.marginLeft = "-15vw";
        // - > Mouse Indicator
        ...
        // Second View
        // - > Carousel
        document.getElementById('software-skills').style.height = "150vw";
        // - > Background
        document.getElementById('software-skills').style.background = "linear-gradient(90deg, black, rgba(0,0,0,0.9) 20%, rgba(0,0,0,0.6)), url('/assets/img/Detail Skills Page - Second Page/Perfect Circles.svg') right / 100vw no-repeat";
        // - > Slide fontsize
        document.querySelectorAll('#slides-of-individual-skill-page-percentages-of-software-skills > div > div > div > h1').forEach(
            function (item) {
                item.style.fontSize = "8vw";
                item.style.marginTop = "60vw";
            }
        );

        // Third View
        // - > Background
        document.getElementById('third-view-projects-cources-books').style.background = "linear-gradient(90deg, rgba(0,0,0,0), rgba(0,0,0,0.8) 26%, rgb(0,0,0) 50%, rgba(0,0,0,0.7) 91%, rgba(0,0,0,0)), url('/assets/img/Perfect Triangles 30 Rotated.png') 40vw 0px / 102vmin no-repeat, url('/assets/img/Perfect Shape Triangles.svg') -30vw 70vw / 100vw no-repeat";
        // - > Each Book, Course, Project Titles
        document.querySelectorAll('#third-view-projects-cources-books > div > div > div > div > div > div > h1').forEach(
            function (item) {
                item.style.fontSize = "8vw";
        ...
        // First View
        // - > Background
        document.getElementById('detail-introduction-first-screen').style.background = "linear-gradient(180deg, rgba(0,0,0,0.3) 5%, rgba(0,0,0,0.99) 40%, rgb(0,0,0, 1) 60%, rgba(0, 0, 0, 1) 30%, rgba(0, 0, 0, 0.7) 30%), url('/assets/img/Detail Skills Page - Second Page/Perfect Shape Triangles.svg') bottom / contain no-repeat, " + "url('" + neededProperties._current_skill_image_intro_background + "') " + " top / contain no-repeat";
        // - > Skill Title
        document.getElementById('first-view-header-introduction-skill-individual-skill-name').style.fontSize = "8vw";
        document.getElementById('first-view-header-introduction-skill-individual-skill-name').style.width = "65vw";
        document.getElementById('first-view-header-introduction-skill-individual-skill-name').style.marginTop = "-40vw";
        document.getElementById('first-view-header-introduction-skill-individual-skill-name').style.marginLeft = "-15vw";
        // - > Intro Paragroph
        document.getElementById('MainTextIndividualSkillParagraphIntroduction').style.fontSize = "5vw";
        document.getElementById('MainTextIndividualSkillParagraphIntroduction').style.width = "65vw";
        document.getElementById('MainTextIndividualSkillParagraphIntroduction').style.marginLeft = "-15vw";
        // - > CTA Go to Project Button
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.fontSize = "5vw";
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.width = "auto";
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.borderRadius = "10px";
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.marginLeft = "-15vw";
        // - > Mouse Indicator
        ...
        // Second View
        // - > Carousel
        document.getElementById('software-skills').style.height = "200vw";
        // - > Background
        document.getElementById('software-skills').style.background = "linear-gradient(90deg, black, rgba(0,0,0,0.9) 20%, rgba(0,0,0,0.6)), url('/assets/img/Detail Skills Page - Second Page/Perfect Circles.svg') right / 100vw no-repeat";
        // - > Slide fontsize
        document.querySelectorAll('#slides-of-individual-skill-page-percentages-of-software-skills > div > div > div > h1').forEach(
        ...
        // Third View
        // - > Background
        document.getElementById('third-view-projects-cources-books').style.background = "linear-gradient(90deg, rgba(0,0,0,0), rgba(0,0,0,0.8) 26%, rgb(0,0,0) 50%, rgba(0,0,0,0.7) 91%, rgba(0,0,0,0)), url('/assets/img/Perfect Triangles 30 Rotated.png') 40vw 0px / 102vmin no-repeat, url('/assets/img/Perfect Shape Triangles.svg') -30vw 100vw / 100vw no-repeat";
        // - > Each Book, Course, Project Titles
        document.querySelectorAll('#third-view-projects-cources-books > div > div > div > div > div > div > h1').forEach(
            function (item) {
                item.style.fontSize = "10vw";
            }
        );
        // - > Short Paragraph
        document.querySelectorAll('#third-view-projects-cources-books > div > div > div > div > div > div > p').forEach(
        ...
        // First View
        // - > Background
        document.getElementById('detail-introduction-first-screen').style.background = "linear-gradient(180deg, rgba(0,0,0,0.3) 5%, rgba(0,0,0,0.89) 50%, rgb(0,0,0, 1) 60%, rgba(0, 0, 0, 1) 30%, rgba(0, 0, 0, 0.7) 30%), url('/assets/img/Detail Skills Page - Second Page/Perfect Shape Triangles.svg') bottom / contain no-repeat, " + "url('" + neededProperties._current_skill_image_intro_background + "') " + " top / contain no-repeat";
        // - > Skill Title
        document.getElementById('first-view-header-introduction-skill-individual-skill-name').style.fontSize = "10vw";
        document.getElementById('first-view-header-introduction-skill-individual-skill-name').style.width = "60vw";
        document.getElementById('first-view-header-introduction-skill-individual-skill-name').style.marginTop = "20vw";
        document.getElementById('first-view-header-introduction-skill-individual-skill-name').style.marginLeft = "-10vw";
        // - > Intro Paragroph
        document.getElementById('MainTextIndividualSkillParagraphIntroduction').style.fontSize = "4vw";
        document.getElementById('MainTextIndividualSkillParagraphIntroduction').style.width = "60vw";
        document.getElementById('MainTextIndividualSkillParagraphIntroduction').style.marginLeft = "-10vw";
        // - > CTA Go to Project Button
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.fontSize = "5vw";
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.width = "auto";
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.borderRadius = "10px";
        document.getElementById('individual-skill-page-first-view-button-text-to-my-done-projects').style.marginLeft = "-10vw";
        // - > Mouse Indicator
        document.getElementById('scroll-mouse-direction-down-animation-detail-skill-view').style.opacity = "0";

        // Second View
        // - > Carousel
        document.getElementById('software-skills').style.height = "120vh";
        // - > Background
        document.getElementById('software-skills').style.background = "linear-gradient(90deg, black, rgba(0,0,0,0.9) 20%, rgba(0,0,0,0.6)), url('/assets/img/Detail Skills Page - Second Page/Perfect Circles.svg') right / 100vw no-repeat";
        // - > Slide fontsize
        document.querySelectorAll('#slides-of-individual-skill-page-percentages-of-software-skills > div > div > div > h1').forEach(
