...
function changeBackgroundOnResize() {
  const specialElement = document.getElementById('detail-introduction-first-screen-AI-engineer-eng'); // Replace with your actual element ID
