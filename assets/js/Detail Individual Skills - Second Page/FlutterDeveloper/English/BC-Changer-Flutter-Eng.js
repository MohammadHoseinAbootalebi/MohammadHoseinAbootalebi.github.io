...
function changeBackgroundOnResize() {
  const specialElement = document.getElementById('detail-introduction-first-screen-flutter-eng'); // Replace with your actual element ID
