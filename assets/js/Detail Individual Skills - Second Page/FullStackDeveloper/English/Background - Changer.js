...
function changeBackgroundOnResize() {
  const specialElement = document.getElementById('detail-introduction-first-screen-full-stack-developer-eng'); // Replace with your actual element ID
