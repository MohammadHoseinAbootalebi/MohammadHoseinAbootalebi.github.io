...
function changeBackgroundOnResize() {
  const specialElement = document.getElementById('detail-introduction-first-screen-indsutrial-designer-eng'); // Replace with your actual element ID
