...
var boorRecordsShortInformationTags = {
    "AuthorTagName": {
        "English": {
            "Female": "Modeling Software : ",
            "Male": "Modeling Software : ",
        },
        "Deutsch": {
            "Female": "Autor : ",
            "Male": "Autor : ",
    ...
    "EditionNumberTag": {
        ...
        "Deutsch": "Name der Branche : ",
        "中国人": "行业名称 ：",
        "Русский": "Название отрасли : ",
        "Français": "Nom de l'industrie : ",
        "日本語": "業種名 : ",
        "한국인": "산업 이름 : ",
        "Español": "Nombre de la industria : ",
        "हिंदी": "उद्योग का नाम : ",
        "Português": "Nome da Indústria : ",
        "বাংলা": "শিল্পের নাম : ",
        "عَرَبِيّ": "اسم الصناعة : ",
        "فارسی": "نام صنعت : ",
    },
    "YearNumberTag": {
        "English": "Year : ",
    ...
    "PageNumberTag": {
        "English": "Page Number : ",
        "Deutsch": "Seitennummer : ",
        "中国人": "页码 ：",
        "Русский": "Номер страницы : ",
        "Français": "Numéro de page : ",
        "日本語": "ページ番号 ：",
        "한국인": "페이지 번호 : ",
        "Español": "Número de página : ",
        "हिंदी": "पृष्ठ संख्या : ",
        "Português": "Número de página : ",
        "বাংলা": "পৃষ্ঠা সংখ্যা : ",
        "عَرَبِيّ": "رقم الصفحة : ",
        "فارسی": "تعداد صفحه : ",
    },
...
var BooksReadForEachSkillStaticContainer = {
    ...
    "Mechanical Engineer": [
        ...
        {
            "ProjectName": "Linear Static Analysis of a Bracket",
            ...
            "shortDescriptionsForPageBookReviewing": {
                // English
                "English": "A linear static analysis of a bracket was performed using Abaqus. The model contains 2,849 elements and 4,144 nodes, with the material properties defined for aluminum. Boundary conditions and coupling constraints were applied at various points on the bracket, including reference points for lug holes. The analysis used C3D8R elements and aimed to study the structural response under static loading. The results showed the model ran successfully.",
                // German
                "Deutsch": "Mit Abaqus wurde eine lineare statische Analyse einer Halterung durchgeführt. Das Modell enthält 2.849 Elemente und 4.144 Knoten, wobei die Materialeigenschaften für Aluminium definiert sind. Randbedingungen und Kopplungsbeschränkungen wurden an verschiedenen Punkten der Halterung angewendet, einschließlich Referenzpunkten für Ösenlöcher. Die Analyse verwendete C3D8R-Elemente und zielte darauf ab, die strukturelle Reaktion unter statischer Belastung zu untersuchen. Die Ergebnisse zeigten, dass das Modell erfolgreich ausgeführt wurde.",
                // Chinese
                "中国人": "使用 Abaqus 对支架进行了线性静态分析。该模型包含 2,849 个元素和 4,144 个节点，材料属性定义为铝。在支架上的各个点（包括凸耳孔的参考点）应用了边界条件和耦合约束。分析使用了 C3D8R 元素，旨在研究静态载荷下的结构响应。结果表明模型运行成功。",
                // Russian
                "Русский": "Линейный статический анализ кронштейна был выполнен с использованием Abaqus. Модель содержит 2849 элементов и 4144 узла, при этом свойства материала были определены для алюминия. Граничные условия и ограничения сцепления были применены в различных точках кронштейна, включая контрольные точки для отверстий под проушины. Анализ использовал элементы C3D8R и был направлен на изучение структурного отклика при статической нагрузке. Результаты показали, что модель успешно отработала.",
                // French
                "Français": "Une analyse statique linéaire d'un support a été réalisée à l'aide d'Abaqus. Le modèle contient 2 849 éléments et 4 144 nœuds, avec les propriétés du matériau définies pour l'aluminium. Des conditions aux limites et des contraintes de couplage ont été appliquées à divers points du support, y compris des points de référence pour les trous de cosse. L'analyse a utilisé des éléments C3D8R et visait à étudier la réponse structurelle sous charge statique. Les résultats ont montré que le modèle fonctionnait avec succès.",
                // Japanese
                "日本語": "Abaqus を使用してブラケットの線形静的解析を実行しました。モデルには 2,849 個の要素と 4,144 個のノードが含まれており、アルミニウムの材料特性が定義されています。境界条件と結合制約は、ラグ穴の参照点を含むブラケットのさまざまなポイントに適用されました。解析では C3D8R 要素を使用し、静的荷重下での構造応答を調べることを目的としていました。結果は、モデルが正常に実行されたことを示しました。",
                // Korean
                "한국인": "Abaqus를 사용하여 브래킷의 선형 정적 해석을 수행했습니다. 이 모델은 2,849개의 요소와 4,144개의 노드를 포함하고 있으며, 알루미늄에 대한 재료 속성이 정의되어 있습니다. 경계 조건과 커플링 제약 조건이 러그 홀의 참조점을 포함하여 브래킷의 다양한 지점에 적용되었습니다. 이 분석은 C3D8R 요소를 사용했으며 정적 하중 하에서 구조적 반응을 연구하는 것을 목표로 했습니다. 결과에 따르면 모델이 성공적으로 실행되었습니다.",
                // Spanish
                "Español": "Se realizó un análisis estático lineal de un soporte utilizando Abaqus. El modelo contiene 2.849 elementos y 4.144 nodos, con las propiedades del material definidas para el aluminio. Se aplicaron condiciones de contorno y restricciones de acoplamiento en varios puntos del soporte, incluidos puntos de referencia para orificios de orejetas. El análisis utilizó elementos C3D8R y tuvo como objetivo estudiar la respuesta estructural bajo carga estática. Los resultados mostraron que el modelo se ejecutó correctamente.",
                // Hindi
                "हिंदी": "Abaqus का उपयोग करके ब्रैकेट का रैखिक स्थैतिक विश्लेषण किया गया। मॉडल में 2,849 तत्व और 4,144 नोड्स हैं, जिसमें एल्युमिनियम के लिए परिभाषित सामग्री गुण हैं। ब्रैकेट पर विभिन्न बिंदुओं पर सीमा की स्थिति और युग्मन बाधाओं को लागू किया गया था, जिसमें लग छेदों के लिए संदर्भ बिंदु शामिल थे। विश्लेषण में C3D8R तत्वों का उपयोग किया गया और इसका उद्देश्य स्थैतिक लोडिंग के तहत संरचनात्मक प्रतिक्रिया का अध्ययन करना था। परिणामों से पता चला कि मॉडल सफलतापूर्वक चला।",
                // Portuguese
                "Português": "Uma análise estática linear de um bracket foi realizada utilizando o Abaqus. O modelo contém 2.849 elementos e 4.144 nós, com as propriedades do material definidas para o alumínio. As condições de contorno e as restrições de acoplamento foram aplicadas em vários pontos do suporte, incluindo pontos de referência para furos nas saliências. A análise utilizou elementos C3D8R e teve como objetivo estudar a resposta estrutural sob carregamento estático. Os resultados mostraram que o modelo foi executado com sucesso.",
                // Bengali
                "বাংলা": "Abaqus ব্যবহার করে একটি বন্ধনীর একটি লিনিয়ার স্ট্যাটিক বিশ্লেষণ করা হয়েছিল। মডেলটিতে 2,849টি উপাদান এবং 4,144টি নোড রয়েছে, যার উপাদান বৈশিষ্ট্যগুলি অ্যালুমিনিয়ামের জন্য সংজ্ঞায়িত করা হয়েছে। সীমানা শর্ত এবং সংযোগের সীমাবদ্ধতা বন্ধনীর বিভিন্ন পয়েন্টে প্রয়োগ করা হয়েছিল, যার মধ্যে লুগ হোলের জন্য রেফারেন্স পয়েন্ট রয়েছে। বিশ্লেষণে C3D8R উপাদান ব্যবহার করা হয়েছে এবং স্ট্যাটিক লোডিংয়ের অধীনে কাঠামোগত প্রতিক্রিয়া অধ্যয়ন করার লক্ষ্য ছিল। ফলাফলগুলি দেখায় যে মডেলটি সফলভাবে চলছে।",
                // Arabic
                "عَرَبِيّ": "تم إجراء تحليل ثابت خطي لقوس باستخدام برنامج Abaqus. يحتوي النموذج على 2849 عنصرًا و4144 عقدة، مع تحديد خصائص المادة للألمنيوم. تم تطبيق الشروط الحدودية وقيود الاقتران في نقاط مختلفة على القوس، بما في ذلك نقاط مرجعية لثقوب العروة. استخدم التحليل عناصر C3D8R وكان الهدف منه دراسة الاستجابة الهيكلية تحت التحميل الثابت. أظهرت النتائج أن النموذج يعمل بنجاح.",
                // Persian
...
function BookListRowCreator(SkillName, Language, StartIndex, EndIndex) {
    ...
    for (var index = StartIndex; index < EndIndex; ++index) {
        ...
        BookNameTitle.textContent = BooksReadForEachSkillStaticContainer[SkillName][index]["ProjectName"];
        ...
        AuthorNameTagH5.textContent = BooksReadForEachSkillStaticContainer[SkillName][index]['ModelingSoftware'];
        ...
        EditionNumberRowH5.textContent = BooksReadForEachSkillStaticContainer[SkillName][index]['IndustryName'];
        ...
        SeeMoreRow.href = BooksReadForEachSkillStaticContainer[SkillName][index]["DetailPageScreenToShowEachBookDetails"] + "?direction=" + encodeURIComponent(SkillName) + "&language=" + encodeURI(Language);
...
function ReadBooksListCallFunctionFunctionality(SkillName, Language) {
    ...
    if (BooksReadForEachSkillStaticContainer[SkillName].length >= 1) {
        ...
        if ((SkillName === "") || (SkillName === " ") || (SkillName == null)) {
            ...
            } else if ((BooksReadForEachSkillStaticContainer[SkillName].length <= 6) && (BooksReadForEachSkillStaticContainer[SkillName].length >= 4) && (document.getElementById('pagination-section-to-show-other-books').childNodes.length == 0)) {
            ...
            } else if ((BooksReadForEachSkillStaticContainer[SkillName].length <= 9) && (BooksReadForEachSkillStaticContainer[SkillName].length >= 7) && (document.getElementById('pagination-section-to-show-other-books').childNodes.length == 0)) {
            ...
            } else if ((BooksReadForEachSkillStaticContainer[SkillName].length >= 10) && (document.getElementById('pagination-section-to-show-other-books').childNodes.length == 0)) {
